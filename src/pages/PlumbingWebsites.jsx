...
import { CheckCircle2, Wrench, ArrowRight, Check, ChevronDown, ChevronUp, ShieldCheck, AlertCircle, Loader2 } from 'lucide-react';
                    ...
                    >
                        ...
                        <motion.div className="flex flex-col items-center gap-4" variants={itemVariants}>
                            ...
                            <p className="text-[10px] md:text-xs text-white/40 uppercase tracking-widest font-bold">
                                Clear pricing • No lock-in contracts • Built for plumbers
                            </p>
                        </motion.div>
