...
const PainterWebsites = () => {
    ...
    return (
        <div className="min-h-screen bg-construction-charcoal text-white font-sans selection:bg-safety-orange selection:text-white">
            <Helmet>
                <title>Professional Painter Websites | Get More Local Jobs | Your Trade Partner</title>
                ...
                <meta property="og:title" content="Professional Painter Websites | Your Trade Partner" />
