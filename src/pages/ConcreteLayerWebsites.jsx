...
const ConcreteLayerWebsites = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            trackLead('concrete_page_form', { tier: 'primary' });
            setFormData({
                name: '',
                email: '',
                phone: '',
    ...
    return (
        <div className="min-h-screen bg-construction-charcoal text-white font-sans selection:bg-safety-orange selection:text-white">
            <Helmet>
                <title>Concrete Layer Website Design Australia | Get More Local Jobs | Your Trade Partner</title>
                <meta name="description" content="Custom websites built specifically for Australian concreters. Stop missing local jobs. Get a professional site that brings in quality enquiries and builds trust with homeowners." />
                <link rel="canonical" href="https://yourtradepartner.com.au/concrete-layer-websites" />
                <meta name="robots" content="index, follow" />

                <meta property="og:type" content="website" />
                <meta property="og:title" content="Concrete Layer Website Design Australia | Your Trade Partner" />
                <meta property="og:description" content="Custom websites for Australian concreters. Professional sites that convert local enquiries into jobs." />
                <meta property="og:url" content="https://yourtradepartner.com.au/concrete-layer-websites" />
                ...
                <script type="application/ld+json">{JSON.stringify({
                    ...
                    "@type": "FAQPage",
                    "mainEntity": [
                        { "@type": "Question", "name": "How long does it take to build a concreter's website?", "acceptedAnswer": { "@type": "Answer", "text": "Depending on the package, most concreter websites are live within 2-4 weeks. The Local Jobs Engine (Package 2) typically takes 2-3 weeks, while the Growth System (Package 3) with advanced features can take 3-4 weeks. We'll give you a clear timeline during the scoping call." } },
                        { "@type": "Question", "name": "Will my concreter website show up on Google?", "acceptedAnswer": { "@type": "Answer", "text": "Yes. Every website we build is optimised for local search from day one. This includes proper page structure, fast loading speeds, mobile responsiveness, and suburb-specific service pages. For Package 3, we also implement advanced local SEO and AI visibility strategies to help you rank higher for 'concreter near me' searches." } },
            ...
            <header className="relative pt-8 pb-24 md:pt-24 md:pb-44 border-b border-white/5 overflow-hidden">
                ...
                <div className="container mx-auto px-6 relative z-10">
                    <Breadcrumbs
                        ...
                        currentLabel="Concrete Layer Websites"
                        currentPath="/concrete-layer-websites"
                        className="mb-8"
                    />
                    <motion.div
                    ...
                    >
                        ...
                        <motion.p className="text-xs text-white/35 font-bold tracking-widest mb-2 -mt-4" variants={itemVariants}>
                            Concreter website design Australia — driveways, slabs, and outdoor entertaining for concreting businesses that win more quotes
                        </motion.p>
                        ...
                        <motion.div className="inline-flex items-center gap-3 bg-white/5 border border-white/10 px-6 py-3 mb-10 rounded-full md:text-sm backdrop-blur-sm" variants={itemVariants}>
                            ...
                            <p className="font-semibold text-white/80">
                                Websites built specifically for Australian concreters — <span className="text-white/40">not generic templates.</span>
                            </p>
                        </motion.div>
                        ...
                        <motion.div className="flex flex-col md:flex-row justify-center items-center gap-4 md:gap-8 mt-12 text-sm text-white/60 font-bold uppercase tracking-wider" variants={itemVariants}>
                            <div className="flex items-center gap-2">
                                ...
                                <span>Built for Australian concreters</span>
                            </div>
                            <div className="flex items-center gap-2">
                                <CheckCircle2 className="w-4 h-4 text-green-500" />
                ...
                <div className="container mx-auto px-6">
                    <div className="max-w-5xl mx-auto">
                        <h2 className="text-4xl md:text-6xl font-black mb-16 uppercase italic text-center md:text-left">
                            Why concreter businesses <br className="hidden md:block" /> need professional websites
                        </h2>
            ...
            <div className="py-12 text-center bg-safety-orange/5 border-y border-safety-orange/20">
                <p className="text-white/60 font-bold uppercase tracking-widest text-sm mb-4">
                    Ready to see what a concreter-specific website looks like?
                </p>
                <a href="#contact">
                ...
                <div className="container mx-auto px-6">
                    <div className="max-w-4xl mx-auto">
                        ...
                        <motion.div className="space-y-6" variants={containerVariants}>
                            {[
                                {
                                    question: "How long does it take to build an concreter's website?",
                                    answer: "Depending on the package, most concreter websites are live within 2-4 weeks. The Local Jobs Engine (Package 2) typically takes 2-3 weeks, while the Growth System (Package 3) with advanced features can take 3-4 weeks. We'll give you a clear timeline during the scoping call."
                                },
                                {
            ...
            >
                <div className="container mx-auto px-6">
                    <div className="max-w-6xl mx-auto">
                        ...
                        <p className="text-white/40 text-center font-bold uppercase tracking-widest mb-16">
                            Not every web agency understands what a concrete layer actually needs to win jobs.
                        </p>
                        ...
                        <div className="overflow-x-auto">
                            <table className="w-full border-collapse">
                                ...
                                <tbody>
                                    {[
                                        { label: "Built for Australian concrete layers", ytp: true, agency: false, diy: false },
                                        { label: "State licensing compliance copy", ytp: true, agency: false, diy: false },
                                        { label: "Slab & finish portfolio photos", ytp: true, agency: "varies", diy: "maybe" },
...
export default ConcreteLayerWebsites;
