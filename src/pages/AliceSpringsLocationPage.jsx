...
const AliceSpringsLocationPage = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            trackLead('alice_springs_page_form', { tier: 'primary' });
        } catch (error) { console.error("Form submission error:", error); setFormStatus('idle'); }
    };

    const aliceSpringsAreas = [
        'Alice Springs CBD', 'Larapinta', 'Braitling', 'Gillen', 'Sadadeen',
        'Ross', 'Araluen', 'Heavitree', 'Stuart Park', 'Desert Springs',
        'Woodleigh Gardens', 'Ilparpa', 'The Gap', 'Ciccone', 'Charles'
    ];
    ...
    return (
        <div className="min-h-screen bg-construction-charcoal text-white font-sans selection:bg-safety-orange selection:text-white">
            ...
            <Helmet>
                <title>Tradie Website Design Alice Springs | Get More Local Jobs | Your Trade Partner</title>
                <meta name="description" content="Alice Springs tradie website design and digital systems that get you found on Google, capture every enquiry, and make you the go-to trade business in the NT." />
                <link rel="canonical" href="https://yourtradepartner.com.au/tradie-website-design-alice-springs" />
                <meta name="robots" content="index, follow" />
                <meta property="og:type" content="website" />
                <meta property="og:title" content="Tradie Website Design Alice Springs | Your Trade Partner" />
                <meta property="og:description" content="Alice Springs tradie website design and digital systems. Get found on Google, capture every enquiry, dominate your local market." />
                <meta property="og:url" content="https://yourtradepartner.com.au/tradie-website-design-alice-springs" />
                <meta property="og:image" content="https://yourtradepartner.com.au/Agency-hammer-favicon.jpeg" />
                <meta property="og:image:width" content="1200" />
                <meta property="og:image:height" content="630" />
                <script type="application/ld+json">{JSON.stringify({ "@context": "https://schema.org", "@type": "Service", "serviceType": "Tradie Website Design Alice Springs", "name": "Tradie Website Design Alice Springs", "description": "Professional website design and digital marketing systems for trade businesses in Alice Springs, NT.", "provider": { "@type": "LocalBusiness", "name": "Your Trade Partner", "url": "https://yourtradepartner.com.au", "telephone": "0451044751", "email": "hello@yourtradepartner.com.au" }, "areaServed": { "@type": "City", "name": "Alice Springs", "containedInPlace": { "@type": "State", "name": "Northern Territory" } } })}</script>
                <script type="application/ld+json">{JSON.stringify({ "@context": "https://schema.org", "@type": "FAQPage", "mainEntity": [{ "@type": "Question", "name": "Do I need a website if I'm one of the only tradies in Alice Springs?", "acceptedAnswer": { "@type": "Answer", "text": "Even in a smaller market, the tradie who looks most professional online wins the best jobs. Government contracts, commercial work, and higher-income homeowners all Google before they call. If your online presence looks weak compared to someone flown in from Darwin, you lose those jobs. A professional website makes you the obvious first call." } }, { "@type": "Question", "name": "How long before I show up in Alice Springs search results?", "acceptedAnswer": { "@type": "Answer", "text": "Alice Springs is a low-competition market online — a properly set up Google Business Profile can appear in results very quickly. SEO typically takes 1–3 months to establish strong positions. Less competition means faster results than capital cities." } }, { "@type": "Question", "name": "Alice Springs is a small market — is digital marketing really worth it?", "acceptedAnswer": { "@type": "Answer", "text": "In a small market, dominating online means you capture a disproportionate share of the work. Government projects, mining-adjacent residential work, and commercial maintenance all go to whoever looks most credible. Being the best-presented trade business online in Alice Springs gives you an outsized advantage with very little competition." } }, { "@type": "Question", "name": "Can you build websites for any trade in Alice Springs?", "acceptedAnswer": { "@type": "Answer", "text": "Yes. We've built digital systems for plumbers, electricians, roofers, builders, HVAC, landscapers, painters, concreters, and carpenters. Each trade has different trust signals and search behaviour — we know the difference and build accordingly." } }, { "@type": "Question", "name": "What does a tradie website cost in Alice Springs?", "acceptedAnswer": { "@type": "Answer", "text": "Our Trade-Ready Online Setup starts at $1,900 one-time + $299/quarter for hosting and support. The Local Jobs Engine (website + SEO + Google Business Profile) is $3,900 + $399/quarter. Full Growth System starts from $7,900. Every project is scoped before you commit — no surprises." } }] })}</script>
            </Helmet>
            ...
            <nav className="border-b border-white/10 bg-construction-charcoal/95 backdrop-blur-sm sticky top-0 z-50">
                <div className="container mx-auto px-6 py-4">
                    <div className="flex items-center justify-between">
                        ...
                        <Badge className="bg-safety-orange/10 text-safety-orange border-safety-orange/20 hover:bg-safety-orange/10 pointer-events-none"><MapPin className="w-3 h-3 mr-1" />Alice Springs, NT</Badge>
                    </div>
                </div>
            </nav>
            ...
            <header className="relative pt-8 pb-24 md:pt-24 md:pb-44 border-b border-white/5 overflow-hidden">
                ...
                <div className="container mx-auto px-6 relative z-10">
                    <Breadcrumbs items={[{ label: 'Home', href: '/' }]} currentLabel="Tradie Website Design Alice Springs" currentPath="/tradie-website-design-alice-springs" className="mb-8" />
                    <motion.div className="max-w-4xl mx-auto text-center" variants={containerVariants} initial="hidden" animate="visible">
                        <motion.p className="text-xs md:text-sm text-white/50 font-bold tracking-[0.2em] uppercase mb-6" variants={itemVariants}>Alice Springs, Northern Territory</motion.p>
                        <motion.h1 className="text-[48px] md:text-[80px] font-black leading-[0.9] mb-4 uppercase italic" variants={itemVariants}>Alice Springs Tradies:<br /><span className="text-safety-orange">Own Your Market Online</span></motion.h1>
                        <motion.p className="text-xs text-white/30 font-bold tracking-widest mb-8 -mt-2" variants={itemVariants}>Tradie website design Alice Springs — less competition online means you can dominate faster than any capital city</motion.p>
                        <motion.p className="text-lg md:text-xl text-white/90 font-medium mb-10 leading-relaxed max-w-3xl mx-auto" variants={itemVariants}>Alice Springs has a high-value trade market with far less online competition than capital cities. The tradesperson who looks most professional online gets the government contracts, the commercial maintenance jobs, and every homeowner who searches Google first — which is most of them.</motion.p>
                        <motion.div className="inline-flex items-center gap-3 bg-white/5 border border-white/10 px-6 py-3 mb-10 rounded-full md:text-sm backdrop-blur-sm" variants={itemVariants}>
                            ...
                            <p className="font-semibold text-white/80">Built for NT trade businesses — <span className="text-white/40">targeted strategy for the Red Centre's unique market.</span></p>
                        </motion.div>
                        <motion.div className="flex flex-col items-center gap-4" variants={itemVariants}>
                            ...
                            <p className="text-[10px] md:text-xs text-white/40 uppercase tracking-widest font-bold">No obligation · Alice Springs-focused strategy · Results or we don't take your money</p>
                        </motion.div>
                        <motion.div className="flex flex-col md:flex-row justify-center items-center gap-4 md:gap-8 mt-12 text-sm text-white/60 font-bold uppercase tracking-wider" variants={itemVariants}>
                            <div className="flex items-center gap-2"><CheckCircle2 className="w-4 h-4 text-green-500" /><span>NT trade specialists</span></div>
                            <div className="flex items-center gap-2"><CheckCircle2 className="w-4 h-4 text-green-500" /><span>Remote-market SEO</span></div>
            ...
            <motion.section className="py-24 md:py-32 border-b border-white/5 bg-black/20" variants={sectionVariants} initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-50px" }}>
                <div className="container mx-auto px-6">
                    <div className="max-w-5xl mx-auto">
                        <h2 className="text-4xl md:text-6xl font-black mb-4 uppercase italic text-center md:text-left">What's happening to Alice Springs tradies<br className="hidden md:block" /> without a strong online presence</h2>
                        <p className="text-white/40 font-bold uppercase tracking-widest mb-16 text-sm">Alice Springs has a small but high-value trade market. The tradespeople winning are the ones locals and newcomers can find instantly.</p>
                        <motion.div className="grid md:grid-cols-2 gap-8 mb-16" variants={containerVariants} initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-50px" }}>
                            {[
                                { title: "Alice Springs homeowner — searches Google, calls the first credible result", detail: "Even in a smaller market, most residents search Google before calling a tradie. If your Google Business Profile has no photos and your website looks like it was built in 2010, the call goes to whoever looks most professional — not whoever is actually best." },
                                { title: "Government and commercial contracts go to businesses that look credible online", detail: "A significant portion of Alice Springs trade work comes from government agencies, NT Housing, and commercial operators. These clients look businesses up online before engaging them. A professional website with clear credentials, licensing, and past work can be the difference between getting on the tender list or not." },
                                { title: "New residents and FIFO workers don't have a local tradie — they Google everything", detail: "Alice Springs has a rotating population of government workers, mining-adjacent staff, and new residents who have no established tradie contacts. They search Google for every job. If you're not showing up with a professional presence, the work goes to someone who is — even if they're less experienced than you." },
                                { title: "With fewer tradies online, a professional presence means you dominate the whole market", detail: "Most Alice Springs trades have little or no online presence. Being the one with a professional website, optimised Google Business Profile, and clear trust signals means you capture the majority of search-driven work in the whole town. In a market this size, dominance is achievable fast." }
                            ].map((item, i) => (
                        ...
                        <div className="text-center md:text-right"><p className="text-3xl md:text-5xl font-black italic uppercase leading-tight">You're not losing Alice Springs jobs on price —<br /><span className="text-safety-orange underline decoration-white/20 underline-offset-8">you're losing them because they found someone else first.</span></p></div>
                    </div>
                </div>
            </motion.section>
            ...
            <motion.section className="py-24 md:py-32 border-b border-white/5 bg-black/30" variants={sectionVariants} initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-50px" }}>
                <div className="container mx-auto px-6">
                    <div className="max-w-6xl mx-auto">
                        <h2 className="text-4xl md:text-6xl font-black mb-4 uppercase italic text-center">What We Build for <span className="text-safety-orange">Alice Springs Tradies</span></h2>
                        <p className="text-white/40 text-center font-bold uppercase tracking-widest mb-16">Not generic marketing. Systems built for how the NT trade market actually works.</p>
                        <motion.div className="grid md:grid-cols-3 gap-8" variants={containerVariants} initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-50px" }}>
                            {[{ icon: "🌐", title: "Trade-Ready Website", features: ["Fast-loading, mobile-first (most searches are phone)", "Pages targeting your Alice Springs service areas", "Click-to-call on every page", "Trust signals: licences, insurance, photos", "Quote forms that send directly to your phone", "Built to rank — not just look good"] }, { icon: "📍", title: "Local SEO & Google Profile", features: ["Google Business Profile set up and optimised", "Targeting Alice Springs areas you actually work in", "Local citations submitted to AU directories", "Review strategy to build your rating fast", "Keyword targeting for your specific trade + area", "Track ranking positions monthly"] }, { icon: "⚡", title: "Enquiry Automation", features: ["Missed-call text-back so no job slips", "After-hours enquiry capture (jobs don't stop at 5pm)", "Instant SMS notification when a new job comes in", "AI enquiry handling for common questions", "Enquiry routing — right job to right person", "Works while you're on the tools"] }].map((item, i) => (
            ...
            <motion.section className="py-24 md:py-32 border-b border-white/5 bg-black/40" variants={sectionVariants} initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-50px" }}>
                <div className="container mx-auto px-6">
                    <div className="max-w-5xl mx-auto text-center">
                        <h2 className="text-4xl md:text-6xl font-black mb-4 uppercase italic">Serving Tradies Across <span className="text-safety-orange">Alice Springs</span></h2>
                        <p className="text-white/40 font-bold uppercase tracking-widest mb-12 text-sm">We work with trade businesses across Alice Springs and the surrounding NT region — from the CBD to the outer residential areas.</p>
                        <div className="flex flex-wrap justify-center gap-3">{aliceSpringsAreas.map((area, i) => <span key={i} className="bg-white/5 border border-white/10 px-4 py-2 text-xs font-black uppercase tracking-widest text-white/60 hover:border-safety-orange/40 hover:text-white/90 transition-colors">{area}</span>)}</div>
                        <p className="text-white/30 text-xs font-bold uppercase tracking-widest mt-8">Not in this list? Get in touch — if you're in NT, we can help.</p>
                    </div>
                </div>
            </motion.section>
            ...
            <motion.section className="py-24 md:py-32 border-b border-white/5 bg-black/30" variants={sectionVariants} initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-50px" }}>
                <div className="container mx-auto px-6">
                    <div className="max-w-4xl mx-auto">
                        <h2 className="text-4xl md:text-6xl font-black mb-16 uppercase italic text-center">Questions from <span className="text-safety-orange">Alice Springs Tradies</span></h2>
                        <motion.div className="space-y-6" variants={containerVariants} initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-50px" }}>
                            {[
                                { question: "Do I need a website if I'm one of the only tradies in Alice Springs?", answer: "Even in a smaller market, the tradie who looks most professional online wins the best jobs. Government contracts, commercial work, and higher-income homeowners all Google before they call. If your online presence looks weak compared to someone flown in from Darwin, you lose those jobs. A professional website makes you the obvious first call." },
                                { question: "How long before I show up in Alice Springs search results?", answer: "Alice Springs is a low-competition market online — a properly set up Google Business Profile can appear in results very quickly. SEO typically takes 1–3 months to establish strong positions. Less competition means faster results than capital cities." },
                                { question: "Alice Springs is a small market — is digital marketing really worth it?", answer: "In a small market, dominating online means you capture a disproportionate share of the work. Government projects, mining-adjacent residential work, and commercial maintenance all go to whoever looks most credible. Being the best-presented trade business online in Alice Springs gives you an outsized advantage with very little competition." },
                                { question: "Can you build websites for any trade in Alice Springs?", answer: "Yes. We've built digital systems for plumbers, electricians, roofers, builders, HVAC, landscapers, painters, concreters, and carpenters. Each trade has different trust signals and search behaviour — we know the difference and build accordingly." },
                                { question: "What does a tradie website cost in Alice Springs?", answer: "Our Trade-Ready Online Setup starts at $1,900 one-time + $299/quarter for hosting and support. The Local Jobs Engine (website + SEO + Google Business Profile) is $3,900 + $399/quarter. Full Growth System starts from $7,900. Every project is scoped before you commit — no surprises." }
                            ].map((faq, i) => {
            ...
            <motion.section id="contact" className="py-24 md:py-32 bg-black/40" variants={sectionVariants} initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-50px" }}>
                <div className="container mx-auto px-6">
                    <div className="max-w-2xl md:max-w-5xl mx-auto">
                        ...
                        <p className="text-white/40 text-center font-bold uppercase tracking-widest mb-12 text-sm">Tell us your trade and we'll show you exactly what's costing you Alice Springs jobs right now.</p>
                        {formStatus === 'success' ? (
                                ...
                                <div className="md:text-2xl md:leading-[2.4] md:text-white/80 font-medium">
                                    ...
                                    <span className="field-wrap block md:inline mb-4 md:mb-0">
                                        ...
                                        <input
                                            ...
                                            onChange={handleInputChange}
                                            className="w-full md:w-auto bg-white/5 border border-white/10 rounded-sm p-3 text-base font-medium text-white placeholder:text-white/30 focus:outline-none focus:border-safety-orange transition-colors md:inline-block md:align-baseline md:bg-transparent md:border-0 md:border-b-2 md:border-white/25 md:rounded-none md:px-1.5 md:py-0.5 md:text-2xl md:placeholder:text-white/30 md:w-56"
                                            placeholder="e.g. Alice Springs CBD, Larapinta, The Gap"
                                        />
...
export default AliceSpringsLocationPage;
