...
import { CheckCircle2, ArrowRight, Check, ChevronDown, ChevronUp, ShieldCheck, AlertCircle, Loader2, Search, Phone } from 'lucide-react';
...
const LandscaperWebsites = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            trackLead('landscaper_page_form', { tier: 'primary' });
            setFormData({
                name: '',
                email: '',
                phone: '',
    ...
    return (
        <div className="min-h-screen bg-construction-charcoal text-white font-sans selection:bg-safety-orange selection:text-white">
            <Helmet>
                <title>Landscaper Website Design Australia | Websites That Get More Calls | Your Trade Partner</title>
                <meta name="description" content="We build websites for Australian landscapers that rank on Google and turn visitors into calls. Garden design, lawn care, retaining walls, irrigation — we know your trade. Clear pricing, 2–4 week turnaround." />
                <link rel="canonical" href="https://yourtradepartner.com.au/landscaper-websites" />
                <meta name="robots" content="index, follow" />

                <meta property="og:type" content="website" />
                <meta property="og:title" content="Landscaper Website Design Australia | Your Trade Partner" />
                <meta property="og:description" content="We build websites for Australian landscapers that rank on Google and turn visitors into calls." />
                <meta property="og:url" content="https://yourtradepartner.com.au/landscaper-websites" />
                    ...
                    {`
                        {
                            ...
                            "@type": "Service",
                            "serviceType": "Landscaper Website Design",
                            "provider": {
                            ...
                            "audience": {
                                "@type": "Audience",
                                "name": "Landscapers and Landscaping Businesses in Australia"
                            }
                        }
                    `}
                </script>
                <script type="application/ld+json">{JSON.stringify({
                    ...
                    "@type": "FAQPage",
                    "mainEntity": [
                        { "@type": "Question", "name": "How long does it take to build a landscaper's website?", "acceptedAnswer": { "@type": "Answer", "text": "Depending on the package, most landscaper websites are live within 2-4 weeks. The Local Jobs Engine (Package 2) typically takes 2-3 weeks, while the Growth System (Package 3) with advanced features can take 3-4 weeks. We'll give you a clear timeline during the scoping call." } },
                        { "@type": "Question", "name": "Will my landscaper website show up on Google?", "acceptedAnswer": { "@type": "Answer", "text": "Yes. Every website we build is optimised for local search from day one. This includes proper page structure, fast loading speeds, mobile responsiveness, and suburb-specific service pages. For Package 3, we also implement advanced local SEO and AI visibility strategies to help you rank higher for 'landscaper near me' searches." } },
                        ...
                        { "@type": "Question", "name": "How much does a landscaper website cost in Australia?", "acceptedAnswer": { "@type": "Answer", "text": "A professional landscaping website in Australia typically costs between $1,900 and $7,900+ depending on the package. Our Package 1 starts at $1,900 for a trade-ready presence, while Package 2 at $3,900 includes full local SEO and suburb pages. With landscape design projects ranging from $5,000 to $100,000+, even one extra client per year makes the website investment worthwhile." } },
                        { "@type": "Question", "name": "What should a landscaping website include?", "acceptedAnswer": { "@type": "Answer", "text": "A landscaping website should showcase completed projects with stunning before-and-after photos, list your specific services (garden design, lawn care, retaining walls, paving), display insurance and licence details, and make it easy for clients to request quotes. A gallery of past gardens is your strongest conversion tool." } },
                        { "@type": "Question", "name": "Do landscapers need suburb pages on their website?", "acceptedAnswer": { "@type": "Answer", "text": "Yes — suburb pages are highly effective for landscaping businesses. Homeowners often search 'landscaper in [suburb]' when looking for local help. Suburb-specific pages signal to Google that you service that area, boosting your local search rankings and making it much easier for nearby clients to discover your business." } }
                    ]
                })}</script>
            </Helmet>
            ...
            <header className="relative pt-8 pb-24 md:pt-24 md:pb-44 border-b border-white/5 overflow-hidden">
                ...
                <div className="container mx-auto px-6 relative z-10">
                    <Breadcrumbs
                        ...
                        currentLabel="Landscaper Websites"
                        currentPath="/landscaper-websites"
                        className="mb-8"
                    />
                    <motion.div
                    ...
                    >
                        ...
                        <motion.p className="text-xs text-white/35 font-bold tracking-widest mb-2 -mt-4" variants={itemVariants}>
                            Landscaper website design Australia — design and construct, maintenance contracts, and outdoor living projects that attract property owner enquiries
                        </motion.p>
                        ...
                        <motion.p className="text-lg md:text-xl text-white/90 font-medium mb-10 leading-relaxed max-w-3xl mx-auto" variants={itemVariants}>
                            When a homeowner is planning a garden redesign or outdoor makeover, they go with the landscaper whose portfolio looks stunning online. Your website does the selling before you even pick up the phone.
                        </motion.p>
                        ...
                        <motion.div className="inline-flex items-center gap-3 bg-white/5 border border-white/10 px-6 py-3 mb-10 rounded-full md:text-sm backdrop-blur-sm" variants={itemVariants}>
                            ...
                            <p className="font-semibold text-white/80">
                                Websites built specifically for Australian landscapers — <span className="text-white/40">not generic templates.</span>
                            </p>
                        </motion.div>
                        ...
                        <motion.div className="flex flex-col md:flex-row justify-center items-center gap-4 md:gap-8 mt-12 text-sm text-white/60 font-bold uppercase tracking-wider" variants={itemVariants}>
                            <div className="flex items-center gap-2">
                                ...
                                <span>Built for Australian landscapers</span>
                            </div>
                            <div className="flex items-center gap-2">
                                <CheckCircle2 className="w-4 h-4 text-green-500" />
                ...
                <div className="container mx-auto px-6">
                    <div className="max-w-5xl mx-auto">
                        <h2 className="text-4xl md:text-6xl font-black mb-16 uppercase italic text-center md:text-left">
                            Why landscaper businesses <br className="hidden md:block" /> need professional websites
                        </h2>
            ...
            {/* What Makes a Landscaper's Website Actually Work Section */}
            <motion.section
                ...
                <div className="container mx-auto px-6">
                    <div className="max-w-6xl mx-auto">
                        <h2 className="text-4xl md:text-6xl font-black mb-4 uppercase italic text-center">
                            What Makes a Landscaper's Website <span className="text-safety-orange">Actually Work</span>
                        </h2>
            ...
            <div className="py-12 text-center bg-safety-orange/5 border-y border-safety-orange/20">
                <p className="text-white/60 font-bold uppercase tracking-widest text-sm mb-4">
                    Ready to see what a landscaper-specific website looks like?
                </p>
                <a href="#contact">
            ...
            >
                <div className="container mx-auto px-6">
                    <div className="max-w-6xl mx-auto">
                        <h2 className="text-4xl md:text-6xl font-black mb-4 uppercase italic text-center">
                            Websites Built for Every <span className="text-safety-orange">Landscaping Service</span>
                        </h2>
                        <p className="text-white/40 text-center font-bold uppercase tracking-widest mb-16">
                            We know the landscaping trade — your website will speak your customers' language.
                        </p>
                        <motion.div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4" variants={containerVariants}>
                            {[
                                "Garden Design", "Lawn Installation & Care", "Retaining Walls", "Paving & Pathways",
                                "Irrigation Systems", "Tree Removal & Pruning", "Pool Landscaping", "Outdoor Entertaining Areas",
                                "Hedging & Planting", "Commercial Landscaping", "Drainage Solutions", "Garden Maintenance"
                            ].map((service, i) => (
            ...
            >
                <div className="container mx-auto px-6">
                    <div className="max-w-6xl mx-auto">
                        <h2 className="text-4xl md:text-6xl font-black mb-4 uppercase italic text-center">
                            We Help Landscapers <span className="text-safety-orange">Across All of Australia</span>
                        </h2>
                        <p className="text-white/40 text-center font-bold uppercase tracking-widest mb-16">
                ...
                <div className="container mx-auto px-6">
                    <div className="max-w-4xl mx-auto">
                        <h2 className="text-4xl md:text-6xl font-black mb-16 uppercase italic text-center">
                            Common Questions <span className="text-safety-orange">From Landscapers</span>
                        </h2>

                        <motion.div className="space-y-6" variants={containerVariants}>
                            {[
                                {
                                    question: "How long does it take to build a landscaper's website?",
                                    answer: "Depending on the package, most landscaper websites are live within 2-4 weeks. The Local Jobs Engine (Package 2) typically takes 2-3 weeks, while the Growth System (Package 3) with advanced features can take 3-4 weeks. We'll give you a clear timeline during the scoping call."
                                },
                                {
                                    question: "Will my landscaping website show up on Google?",
                                ...
                                {
                                    question: "How much does a landscaper website cost in Australia?",
                                    answer: "A professional landscaping website in Australia typically costs between $1,900 and $7,900+ depending on the package. Our Package 1 starts at $1,900 for a trade-ready presence, while Package 2 at $3,900 includes full local SEO and suburb pages. With landscape design projects ranging from $5,000 to $100,000+, even one extra client per year makes the website investment worthwhile."
                                },
                                {
                                    question: "What should a landscaping website include?",
                                    answer: "A landscaping website should showcase completed projects with stunning before-and-after photos, list your specific services (garden design, lawn care, retaining walls, paving), display insurance and licence details, and make it easy for clients to request quotes. A gallery of past gardens is your strongest conversion tool."
                                },
                                {
                                    question: "Do landscapers need suburb pages on their website?",
                                    answer: "Yes — suburb pages are highly effective for landscaping businesses. Homeowners often search 'landscaper in [suburb]' when looking for local help. Suburb-specific pages signal to Google that you service that area, boosting your local search rankings and making it much easier for nearby clients to discover your business."
                                }
                            ].map((faq, i) => {
            ...
            >
                <div className="container mx-auto px-6">
                    <div className="max-w-6xl mx-auto">
                        ...
                        <p className="text-white/40 text-center font-bold uppercase tracking-widest mb-16">
                            Not every web agency understands what a landscaper actually needs to win design jobs.
                        </p>
                        ...
                        <div className="overflow-x-auto">
                            <table className="w-full border-collapse">
                                ...
                                <tbody>
                                    {[
                                        { label: "Built for Australian landscapers", ytp: true, agency: false, diy: false },
                                        { label: "State licensing compliance copy", ytp: true, agency: false, diy: false },
                                        { label: "Before/after transformation portfolio", ytp: true, agency: "varies", diy: "maybe" },
                            ...
                            <Card className="bg-white/5 border-2 border-white/10 rounded-none h-full flex flex-col">
                                ...
                                <div className={`${expandedPackages.includes(1) ? 'block' : 'hidden'} md:block flex-grow flex flex-col`}>
                                    <CardContent className="p-5 md:p-6 space-y-4 flex-grow">
                                        <p className="text-xs font-black uppercase tracking-widest text-safety-orange mb-4">FOR LANDSCAPERS WHO WANT TO LOOK PROFESSIONAL AND STOP LOSING JOBS DUE TO WEAK ONLINE PRESENCE.</p>
                        ...
                        <motion.div whileHover={hoverLift} className="h-full">
                            <Card className="bg-white/5 border-2 border-white/10 rounded-none h-full flex flex-col">
                                ...
                                <div className={`${expandedPackages.includes(2) ? 'block' : 'hidden'} md:block flex-grow flex flex-col`}>
                                    <CardContent className="p-5 md:p-6 space-y-4 flex-grow">
                                        <p className="text-xs font-black uppercase tracking-widest text-safety-orange mb-4">FOR LANDSCAPERS WHO WANT STEADY ENQUIRIES WITHOUT ADDING ADMIN OR MISSED CALLS.</p>
                        ...
                        <div className="max-w-xl md:max-w-5xl mx-auto">
                            <div className="mb-10">
                                <h2 className="text-3xl md:text-5xl font-black mb-4 uppercase italic leading-none tracking-tighter text-white">
                                    Ready To Get More <br /> <span className="text-safety-orange">Quality Landscaping Jobs?</span>
                                </h2>
                            </div>
                            ...
                            <form onSubmit={handleSubmit} className="text-left space-y-6 bg-zinc-900/80 p-6 md:p-10 border border-white/10 backdrop-blur-sm shadow-2xl">
                                ...
                                <div className="pt-2 gap-4 flex flex-col items-center">
                                    ...
                                    <p className="text-center text-xs md:text-sm font-bold text-white/80 mt-2">
                                        You'll receive a detailed quote tailored to your landscaping business.
                                    </p>
...
export default LandscaperWebsites;
