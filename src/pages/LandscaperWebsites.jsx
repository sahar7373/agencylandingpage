...
import { CheckCircle2, TreeDeciduous, ArrowRight, Check, ChevronDown, ChevronUp, ShieldCheck, AlertCircle, Loader2 } from 'lucide-react';
                ...
                <div className="container mx-auto px-6">
                    <div className="max-w-6xl mx-auto">
                        ...
                        >
                            {[
                                {
                                    icon: <TreeDeciduous className="w-12 h-12 text-safety-orange" />,
