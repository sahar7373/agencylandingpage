            ...
            <Helmet>
                ...
                <script type="application/ld+json">{JSON.stringify({
                    ...
                    "mainEntity": [
                        ...
                        { "@type": "Question", "name": "How long before I see results from tradie marketing?", "acceptedAnswer": { "@type": "Answer", "text": "A professional website and Google Business Profile can start generating enquiries within weeks. SEO takes 3–6 months to build momentum. If you need results faster, ads can speed things up — they're optional, run separately from the packages, and paid directly by you." } },
                            ...
                            {[
                                {
                                    ...
                                    answer: "Not necessarily. Most tradies get solid results from a professional website, Google Business Profile, and local SEO before spending anything on ads. Ads speed things up once your foundation is solid — but without that foundation, ad spend gets wasted fast. Ads aren't bundled into any package — you run them directly and stay in control of the spend. If you do go that route, we help set the structure so it isn't wasted."
                                },
                                {
                                    question: "How long before I see results?",
                                    answer: "A professional website and Google Business Profile can start generating enquiries within weeks of going live. Local SEO takes 3–6 months to build real momentum. If you need results faster, ads can speed things up — they're optional, run separately from the packages, and paid directly by you."
                                },
                                {
