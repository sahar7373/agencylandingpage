...
const PerthLocationPage = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            trackLead('perth_page_form', { tier: 'primary' });
    ...
    const perthSuburbs = [
        'Joondalup', 'Fremantle', 'Rockingham', 'Mandurah', 'Armadale',
        'Midland', 'Morley', 'Cannington', 'Stirling', 'Scarborough',
        'Cottesloe', 'Claremont', 'Subiaco', 'Leederville', 'Victoria Park',
        'Bentley', 'Canning Vale', 'Gosnells', 'Balcatta', 'Karrinyup',
        'Innaloo', 'Osborne Park', 'Wembley', 'Nedlands', 'Clarkson',
        'Butler', 'Alkimos', 'Yanchep', 'Ellenbrook', 'Byford'
    ];
    ...
    return (
        <div className="min-h-screen bg-construction-charcoal text-white font-sans selection:bg-safety-orange selection:text-white">
            ...
            <Helmet>
                <title>Tradie Website Design Perth | Get More Local Jobs | Your Trade Partner</title>
                <meta name="description" content="Perth tradie website design and digital systems that get you found on Google, capture every enquiry, and stop you losing jobs to competitors across the Greater Perth metro." />
                <link rel="canonical" href="https://yourtradepartner.com.au/tradie-website-design-perth" />
                <meta name="robots" content="index, follow" />

                <meta property="og:type" content="website" />
                <meta property="og:title" content="Tradie Website Design Perth | Your Trade Partner" />
                <meta property="og:description" content="Perth tradie website design and digital systems. Get found on Google, capture every enquiry, stop losing jobs to competitors." />
                <meta property="og:url" content="https://yourtradepartner.com.au/tradie-website-design-perth" />
                ...
                <script type="application/ld+json">
                    {JSON.stringify({
                        ...
                        "@type": "Service",
                        "serviceType": "Tradie Website Design Perth",
                        "name": "Tradie Website Design Perth",
                        "description": "Professional website design and digital marketing systems for trade businesses in Perth, WA. We help plumbers, electricians, roofers, builders and all trades get found online and capture more local jobs.",
                        "provider": {
                            "@type": "LocalBusiness",
                ...
                <script type="application/ld+json">{JSON.stringify({
                    ...
                    "@type": "FAQPage",
                    "mainEntity": [
                        { "@type": "Question", "name": "Do I need a website if I already get work by word of mouth in Perth?", "acceptedAnswer": { "@type": "Answer", "text": "Word of mouth works — until it stops. It doesn't reach the homeowner who just moved to Alkimos, needs an electrician, and searches Google at 8pm. A professional website and Google Business Profile means you're the tradie they find, even without a referral. Your word-of-mouth leads also check you out online before they call — and if you look weak, they call someone else." } },
                        { "@type": "Question", "name": "How long before I show up in Perth search results?", "acceptedAnswer": { "@type": "Answer", "text": "A properly set up Google Business Profile can appear in local results within days to weeks. Your website's SEO takes 3–6 months to build real ranking momentum. If you need jobs faster, we can include Google Ads management to get calls coming in within days of launch." } },
                        { "@type": "Question", "name": "Perth is so spread out — can you target just my area?", "acceptedAnswer": { "@type": "Answer", "text": "Yes. We build suburb-specific pages and SEO strategies targeting exactly where you work — whether that's the northern corridor, southern suburbs, the hills, or the inner city. You don't need to rank across all of Perth, just in the areas that send you work." } },
                        { "@type": "Question", "name": "Can you build websites for any trade in Perth?", "acceptedAnswer": { "@type": "Answer", "text": "Yes. We've built digital systems for plumbers, electricians, roofers, builders, HVAC, landscapers, painters, concreters, and carpenters across Greater Perth. Each trade has different trust signals and search behaviour — we know the difference and build accordingly." } },
                        { "@type": "Question", "name": "What does a tradie website cost in Perth?", "acceptedAnswer": { "@type": "Answer", "text": "Our Trade-Ready Online Setup starts at $1,900 one-time + $299/quarter for hosting and support. The Local Jobs Engine (website + SEO + Google Business Profile) is $3,900 + $399/quarter. Full Growth System starts from $7,900. Every project is scoped before you commit — no surprises." } }
                    ]
                })}</script>
            </Helmet>
            ...
            <header className="relative pt-8 pb-24 md:pt-24 md:pb-44 border-b border-white/5 overflow-hidden">
                ...
                <div className="container mx-auto px-6 relative z-10">
                    <Breadcrumbs
                        ...
                        currentLabel="Tradie Website Design Perth"
                        currentPath="/tradie-website-design-perth"
                        className="mb-8"
                    />
                    <motion.div
                    ...
                    >
                        ...
                        <motion.p className="text-xs text-white/30 font-bold tracking-widest mb-8 -mt-2" variants={itemVariants}>
                            Tradie website design Perth — built for the most spread-out metro trade market in Australia
                        </motion.p>
                        ...
                        <motion.p className="text-lg md:text-xl text-white/90 font-medium mb-10 leading-relaxed max-w-3xl mx-auto" variants={itemVariants}>
                            Perth homeowners search Google before they call. With the city stretching from Yanchep to Mandurah, if you don't show up, look professional, and make it easy to get in touch — they've already called someone else before you even know the job existed.
                        </motion.p>
                        ...
                        <motion.div className="inline-flex items-center gap-3 bg-white/5 border border-white/10 px-6 py-3 mb-10 rounded-full md:text-sm backdrop-blur-sm" variants={itemVariants}>
                            ...
                            <p className="font-semibold text-white/80">
                                Built for WA trade businesses — <span className="text-white/40">suburb-specific strategy, not a generic template.</span>
                            </p>
                        </motion.div>
                        ...
                        <motion.div className="flex flex-col items-center gap-4" variants={itemVariants}>
                            ...
                            <p className="text-[10px] md:text-xs text-white/40 uppercase tracking-widest font-bold">
                                No obligation · Perth-focused strategy · Results or we don't take your money
                            </p>
                        </motion.div>
                        ...
                        <motion.div className="flex flex-col md:flex-row justify-center items-center gap-4 md:gap-8 mt-12 text-sm text-white/60 font-bold uppercase tracking-wider" variants={itemVariants}>
                            <div className="flex items-center gap-2">
                                ...
                                <span>WA trade specialists</span>
                            </div>
                            <div className="flex items-center gap-2">
                                <CheckCircle2 className="w-4 h-4 text-green-500" />
                ...
                <div className="container mx-auto px-6">
                    <div className="max-w-5xl mx-auto">
                        <h2 className="text-4xl md:text-6xl font-black mb-4 uppercase italic text-center md:text-left">
                            What's happening to Perth tradies<br className="hidden md:block" /> without a strong online presence
                        </h2>
                        <p className="text-white/40 font-bold uppercase tracking-widest mb-16 text-sm">
                            Perth stretches further than any city in Australia. If you're not visible online, you're invisible to every job outside your street.
                        </p>
                        ...
                        <motion.div className="grid md:grid-cols-2 gap-8 mb-16" variants={containerVariants} initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-50px" }}>
                            {[
                                {
                                    title: "Balcatta homeowner, 6pm — searches Google, calls the first result",
                                    detail: "That tradie isn't better than you. They just show up first. Perth homeowners don't scroll past the top three results. If your Google Business Profile is thin, your website looks dated, or you don't rank for your suburb — that job goes to a competitor before you know it existed."
                                },
                                {
                                    title: "The northern corridor is exploding — Butler, Alkimos, Yanchep are full of homeowners who don't know any tradies yet",
                                    detail: "Tens of thousands of new homes are being built north of Joondalup. These homeowners search Google for every job they need done. If you're not there, a competitor who set up their digital presence years ago is capturing every single one of those calls."
                                },
                                {
                                    title: "Perth's FIFO workers have cash and urgent problems — they search, they don't ask around",
                                    detail: "FIFO workers and their families often have money but no time. When something breaks, they Google it. A professional website with clear pricing, trust signals, and an easy way to get in touch is the difference between getting the call and being completely invisible."
                                },
                                {
                                    title: "Missed calls during a job in the south are missed jobs — forever",
                                    detail: "Perth's spread means you can be 40 minutes from your next job. If a homeowner in Fremantle calls while you're finishing a job in Armadale and hits voicemail, they immediately call the next result. An automated response system means you capture every enquiry, even on the road."
                                }
                            ].map((item, i) => (
                        ...
                        <div className="text-center md:text-right">
                            <p className="text-3xl md:text-5xl font-black italic uppercase leading-tight">
                                You're not losing Perth jobs on price —<br />
                ...
                <div className="container mx-auto px-6">
                    <div className="max-w-6xl mx-auto">
                        <h2 className="text-4xl md:text-6xl font-black mb-4 uppercase italic text-center">
                            What We Build for <span className="text-safety-orange">Perth Tradies</span>
                        </h2>
                        <p className="text-white/40 text-center font-bold uppercase tracking-widest mb-16">
                            Not generic marketing. Systems built for how the WA trade market actually works.
                        </p>
                            ...
                            {[
                                {
                                    ...
                                    features: [
                                        ...
                                        "Suburb pages targeting your Perth service area",
                                ...
                                },
                                {
                                    ...
                                    features: [
                                        ...
                                        "Targeting Perth suburbs you actually work in",
                ...
                <div className="container mx-auto px-6">
                    <div className="max-w-5xl mx-auto text-center">
                        <h2 className="text-4xl md:text-6xl font-black mb-4 uppercase italic">
                            Serving Tradies Across <span className="text-safety-orange">Greater Perth</span>
                        </h2>
                        <p className="text-white/40 font-bold uppercase tracking-widest mb-12 text-sm">
                            We work with trade businesses across the full Perth metro — Northern Corridor, Southern Suburbs, Hills District, and the inner city.
                        </p>

                        <div className="flex flex-wrap justify-center gap-3">
                            {perthSuburbs.map((suburb, i) => (
                                <span
                                    key={i}
                        ...
                        <p className="text-white/30 text-xs font-bold uppercase tracking-widest mt-8">
                            Not in this list? Get in touch — if you're in WA, we can help.
                        </p>
                    </div>
                </div>
            </motion.section>
                ...
                <div className="container mx-auto px-6">
                    <div className="max-w-4xl mx-auto">
                        <h2 className="text-4xl md:text-6xl font-black mb-16 uppercase italic text-center">
                            Questions from <span className="text-safety-orange">Perth Tradies</span>
                        </h2>
                        ...
                        <motion.div className="space-y-6" variants={containerVariants} initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-50px" }}>
                            {[
                                {
                                    question: "Do I need a website if I already get work by word of mouth in Perth?",
                                    answer: "Word of mouth works — until it stops. It doesn't reach the homeowner who just moved to Alkimos, needs an electrician, and searches Google at 8pm. A professional website and Google Business Profile means you're the tradie they find, even without a referral. Your word-of-mouth leads also check you out online before they call — and if you look weak, they call someone else."
                                },
                                {
                                    question: "How long before I show up in Perth search results?",
                                    answer: "A properly set up Google Business Profile can appear in local results within days to weeks. Your website's SEO takes 3–6 months to build real ranking momentum. If you need jobs faster, we can include Google Ads management to get calls coming in within days of launch."
                                },
                                {
                                    question: "Perth is so spread out — can you target just my area?",
                                    answer: "Yes. We build suburb-specific pages and SEO strategies targeting exactly where you work — whether that's the northern corridor, southern suburbs, the hills, or the inner city. You don't need to rank across all of Perth, just in the areas that send you work."
                                },
                                {
                                    question: "Can you build websites for any trade in Perth?",
                                    answer: "Yes. We've built digital systems for plumbers, electricians, roofers, builders, HVAC, landscapers, painters, concreters, and carpenters across Greater Perth. Each trade has different trust signals and search behaviour — we know the difference and build accordingly."
                                },
                                {
                                    question: "What does a tradie website cost in Perth?",
                ...
                <div className="container mx-auto px-6">
                    <div className="max-w-2xl mx-auto">
                        ...
                        <p className="text-white/40 text-center font-bold uppercase tracking-widest mb-12 text-sm">
                            Tell us your trade and we'll show you exactly what's costing you Perth jobs right now.
                        </p>
                        ...
                        {formStatus === 'success' ? (
                            ...
                            <form onSubmit={handleSubmit} className="space-y-4">
                                ...
                                <div>
                                    <label className="text-[10px] font-black uppercase tracking-widest text-white/40 block mb-2">Perth Suburb / Area</label>
                                    <input
                                        type="text"
                                        name="location"
                                        ...
                                        onChange={handleInputChange}
                                        className="w-full bg-white/5 border border-white/10 text-white px-4 py-3 text-sm font-bold focus:outline-none focus:border-safety-orange/50 transition-colors"
                                        placeholder="e.g. Joondalup, Fremantle, Canning Vale"
                                    />
                                </div>
...
export default PerthLocationPage;
