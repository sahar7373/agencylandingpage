...
import { CheckCircle2, Wind, ArrowRight, ArrowLeft, Check, ChevronDown, ChevronUp, ShieldCheck, AlertCircle, Loader2 } from 'lucide-react';
...
const HVACWebsites = () => {
    ...
    return (
        <div className="min-h-screen bg-construction-charcoal text-white font-sans selection:bg-safety-orange selection:text-white">
            <Helmet>
                <title>HVAC Website Design Australia | Get More Local Jobs | Your Trade Partner</title>
                <meta name="description" content="Custom websites built specifically for Australian hvacs. Stop missing local jobs. Get a professional site that brings in quality enquiries and builds trust with homeowners." />
                <link rel="canonical" href="https://yourtradepartner.com.au/hvac-websites" />
                <meta name="robots" content="index, follow" />

                <meta property="og:type" content="website" />
                <meta property="og:title" content="HVAC Website Design Australia | Your Trade Partner" />
                <meta property="og:description" content="Custom websites for Australian hvacs. Professional sites that convert local enquiries into jobs." />
                    ...
                    {`
                        {
                            ...
                            "audience": {
                                "@type": "Audience",
                                "name": "HVACs and Electrical Businesses in Australia"
                            }
                        }
                    `}
                </script>
                ...
                <div className="container mx-auto px-6">
                    <div className="max-w-4xl mx-auto">
                        <h2 className="text-4xl md:text-6xl font-black mb-16 uppercase italic text-center">
                            Common Questions <span className="text-safety-orange">From HVACs</span>
                        </h2>

                        <motion.div className="space-y-6" variants={containerVariants}>
                            {[
                                {
                                    question: "How long does it take to build an hvac's website?",
