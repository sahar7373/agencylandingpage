...
const HVACWebsites = () => {
    ...
    return (
        <div className="min-h-screen bg-construction-charcoal text-white font-sans selection:bg-safety-orange selection:text-white">
            <Helmet>
                <title>Professional HVAC Websites | Get More Local Jobs | Your Trade Partner</title>
                ...
                <meta property="og:title" content="Professional HVAC Websites | Your Trade Partner" />
