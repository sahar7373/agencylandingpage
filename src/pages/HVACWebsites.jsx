...
const HVACWebsites = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            trackLead('hvac_page_form', { tier: 'primary' });
            setFormData({
                name: '',
                email: '',
                phone: '',
    ...
    return (
        <div className="min-h-screen bg-construction-charcoal text-white font-sans selection:bg-safety-orange selection:text-white">
            <Helmet>
                <title>HVAC & Air Conditioning Website Design Australia | Websites That Get More Calls | Your Trade Partner</title>
                <meta name="description" content="We build websites for Australian HVAC technicians that rank on Google and turn visitors into calls. Air con installation, servicing, ducted systems, commercial HVAC — we know your trade. Clear pricing, 2–4 week turnaround." />
                <link rel="canonical" href="https://yourtradepartner.com.au/hvac-websites" />
                <meta name="robots" content="index, follow" />

                <meta property="og:type" content="website" />
                <meta property="og:title" content="HVAC & Air Conditioning Website Design Australia | Your Trade Partner" />
                <meta property="og:description" content="We build websites for Australian HVAC technicians that rank on Google and turn visitors into calls." />
                <meta property="og:url" content="https://yourtradepartner.com.au/hvac-websites" />
                    ...
                    {`
                        {
                            ...
                            "audience": {
                                "@type": "Audience",
                                "name": "HVAC and Air Conditioning Businesses in Australia"
                            }
                        }
                    `}
                </script>
                <script type="application/ld+json">{JSON.stringify({
                    ...
                    "@type": "FAQPage",
                    "mainEntity": [
                        { "@type": "Question", "name": "How long does it take to build an HVAC website?", "acceptedAnswer": { "@type": "Answer", "text": "Depending on the package, most HVAC websites are live within 2-4 weeks. The Local Jobs Engine (Package 2) typically takes 2-3 weeks, while the Growth System (Package 3) with advanced features can take 3-4 weeks. We'll give you a clear timeline during the scoping call." } },
                        { "@type": "Question", "name": "Will my HVAC website show up on Google?", "acceptedAnswer": { "@type": "Answer", "text": "Yes. Every website we build is optimised for local search from day one. This includes proper page structure, fast loading speeds, mobile responsiveness, and suburb-specific service pages. For Package 3, we also implement advanced local SEO and AI visibility strategies to help you rank higher for 'HVAC near me' searches." } },
                        ...
                        { "@type": "Question", "name": "How much does an HVAC website cost in Australia?", "acceptedAnswer": { "@type": "Answer", "text": "A professional HVAC website in Australia typically costs between $1,900 and $7,900+ depending on the package. Our Package 1 starts at $1,900 for a trade-ready presence, while Package 2 at $3,900 includes full local SEO and suburb pages. With split system installations averaging $2,000–$4,000 and ducted system installs reaching $8,000–$20,000, a few extra leads per year more than justify the investment." } },
                        { "@type": "Question", "name": "What should an HVAC website include?", "acceptedAnswer": { "@type": "Answer", "text": "An HVAC website should prominently display your ARCtick licence number (required for refrigerant handling in Australia), list specific services (installation, servicing, repairs), showcase brands you're accredited for, and make it simple for customers to book a service call or installation quote. Emergency contact details are essential as many HVAC calls are urgent." } },
                        { "@type": "Question", "name": "Do HVAC technicians need suburb pages on their website?", "acceptedAnswer": { "@type": "Answer", "text": "Yes — suburb pages are one of the most effective additions to an HVAC website. When homeowners search 'air conditioning installer in [suburb]' Google looks for a page specifically about that area. Suburb pages signal local expertise and improve your chances of appearing in local search results for high-intent, ready-to-buy customers." } }
                    ]
                })}</script>
            </Helmet>
            ...
            <header className="relative pt-8 pb-24 md:pt-24 md:pb-44 border-b border-white/5 overflow-hidden">
                ...
                <div className="container mx-auto px-6 relative z-10">
                    <Breadcrumbs
                        ...
                        currentLabel="HVAC Websites"
                        currentPath="/hvac-websites"
                        className="mb-8"
                    />
                    <motion.div
                    ...
                    >
                        ...
                        <motion.p className="text-xs text-white/35 font-bold tracking-widest mb-2 -mt-4" variants={itemVariants}>
                            HVAC website design Australia — heating, cooling, and air conditioning businesses that need more installs and service bookings year-round
                        </motion.p>
                        ...
                        <motion.p className="text-lg md:text-xl text-white/90 font-medium mb-10 leading-relaxed max-w-3xl mx-auto" variants={itemVariants}>
                            When a homeowner's air con dies on a 40-degree day, they're calling the HVAC company that looks trustworthy online — not the cheapest one. Your website makes that first impression.
                        </motion.p>
                        ...
                        <motion.div className="inline-flex items-center gap-3 bg-white/5 border border-white/10 px-6 py-3 mb-10 rounded-full md:text-sm backdrop-blur-sm" variants={itemVariants}>
                            ...
                            <p className="font-semibold text-white/80">
                                Websites built specifically for Australian hvacs — <span className="text-white/40">not generic templates.</span>
                            </p>
                        </motion.div>
                        ...
                        <motion.div className="flex flex-col md:flex-row justify-center items-center gap-4 md:gap-8 mt-12 text-sm text-white/60 font-bold uppercase tracking-wider" variants={itemVariants}>
                            <div className="flex items-center gap-2">
                                ...
                                <span>Built for Australian hvacs</span>
                            </div>
                            <div className="flex items-center gap-2">
                                <CheckCircle2 className="w-4 h-4 text-green-500" />
                ...
                <div className="container mx-auto px-6">
                    <div className="max-w-5xl mx-auto">
                        <h2 className="text-4xl md:text-6xl font-black mb-16 uppercase italic text-center md:text-left">
                            Why hvac businesses <br className="hidden md:block" /> need professional websites
                        </h2>
            ...
            {/* What Makes an HVAC's Website Actually Work Section */}
            <motion.section
                ...
                <div className="container mx-auto px-6">
                    <div className="max-w-6xl mx-auto">
                        <h2 className="text-4xl md:text-6xl font-black mb-4 uppercase italic text-center">
                            What Makes an HVAC's Website <span className="text-safety-orange">Actually Work</span>
                        </h2>
            ...
            <div className="py-12 text-center bg-safety-orange/5 border-y border-safety-orange/20">
                <p className="text-white/60 font-bold uppercase tracking-widest text-sm mb-4">
                    Ready to see what an HVAC-specific website looks like?
                </p>
                <a href="#contact">
            ...
            >
                <div className="container mx-auto px-6">
                    <div className="max-w-6xl mx-auto">
                        <h2 className="text-4xl md:text-6xl font-black mb-4 uppercase italic text-center">
                            Websites Built for Every <span className="text-safety-orange">HVAC Service</span>
                        </h2>
                        <p className="text-white/40 text-center font-bold uppercase tracking-widest mb-16">
                            We know the HVAC trade — your website will speak your customers' language.
                        </p>
                        <motion.div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4" variants={containerVariants}>
                            {[
                                "Split System Installation", "Ducted Air Conditioning", "Evaporative Cooling", "Air Con Servicing & Repairs",
                                "Commercial HVAC", "Refrigeration", "Ventilation Systems", "Zone Control Systems",
                                "Gas Heating", "Reverse Cycle Systems", "Air Con Removal", "Emergency HVAC"
                            ].map((service, i) => (
            ...
            >
                <div className="container mx-auto px-6">
                    <div className="max-w-6xl mx-auto">
                        <h2 className="text-4xl md:text-6xl font-black mb-4 uppercase italic text-center">
                            We Help HVAC Technicians <span className="text-safety-orange">Across All of Australia</span>
                        </h2>
                        <p className="text-white/40 text-center font-bold uppercase tracking-widest mb-16">
                ...
                <div className="container mx-auto px-6">
                    <div className="max-w-4xl mx-auto">
                        <h2 className="text-4xl md:text-6xl font-black mb-16 uppercase italic text-center">
                            Common Questions <span className="text-safety-orange">From HVAC Technicians</span>
                        </h2>
                            ...
                            {[
                                {
                                    ...
                                    answer: "Depending on the package, most HVAC websites are live within 2-4 weeks. The Local Jobs Engine (Package 2) typically takes 2-3 weeks, while the Growth System (Package 3) with advanced features can take 3-4 weeks. We'll give you a clear timeline during the scoping call."
                                },
                                {
                                    question: "Will my HVAC website show up on Google?",
                                    answer: "Yes. Every website we build is optimised for local search from day one. This includes proper page structure, fast loading speeds, mobile responsiveness, and suburb-specific service pages. For Package 3, we also implement advanced local SEO and AI visibility strategies to help you rank higher for 'air conditioning near me' searches."
                                },
                                {
                                ...
                                {
                                    question: "How much does an HVAC website cost in Australia?",
                                    answer: "A professional HVAC website in Australia typically costs between $1,900 and $7,900+ depending on the package. Our Package 1 starts at $1,900 for a trade-ready presence, while Package 2 at $3,900 includes full local SEO and suburb pages. With split system installations averaging $2,000–$4,000 and ducted system installs reaching $8,000–$20,000, a few extra leads per year more than justify the investment."
                                },
                                {
                                    question: "What should an HVAC website include?",
                                    answer: "An HVAC website should prominently display your ARCtick licence number (required for refrigerant handling in Australia), list specific services (installation, servicing, repairs), showcase brands you're accredited for, and make it simple for customers to book a service call or installation quote. Emergency contact details are essential as many HVAC calls are urgent."
                                },
                                {
                                    question: "Do HVAC technicians need suburb pages on their website?",
                                    answer: "Yes — suburb pages are one of the most effective additions to an HVAC website. When homeowners search 'air conditioning installer in [suburb]' Google looks for a page specifically about that area. Suburb pages signal local expertise and improve your chances of appearing in local search results for high-intent, ready-to-buy customers."
                                }
                            ].map((faq, i) => {
            ...
            >
                <div className="container mx-auto px-6">
                    <div className="max-w-6xl mx-auto">
                        ...
                        <p className="text-white/40 text-center font-bold uppercase tracking-widest mb-16">
                            Not every web agency understands what an HVAC contractor actually needs to win installs.
                        </p>
                        ...
                        <div className="overflow-x-auto">
                            <table className="w-full border-collapse">
                                ...
                                <tbody>
                                    {[
                                        { label: "Built for Australian HVAC contractors", ytp: true, agency: false, diy: false },
                                        { label: "State licensing compliance copy", ytp: true, agency: false, diy: false },
                                        { label: "System install & service portfolio", ytp: true, agency: "varies", diy: "maybe" },
                            ...
                            <Card className="bg-white/5 border-2 border-white/10 rounded-none h-full flex flex-col">
                                ...
                                <div className={`${expandedPackages.includes(1) ? 'block' : 'hidden'} md:block flex-grow flex flex-col`}>
                                    <CardContent className="p-5 md:p-6 space-y-4 flex-grow">
                                        <p className="text-xs font-black uppercase tracking-widest text-safety-orange mb-4">FOR HVAC TECHNICIANS WHO WANT TO LOOK PROFESSIONAL AND STOP LOSING JOBS DUE TO WEAK ONLINE PRESENCE.</p>
                        ...
                        <motion.div whileHover={hoverLift} className="h-full">
                            <Card className="bg-white/5 border-2 border-white/10 rounded-none h-full flex flex-col">
                                ...
                                <div className={`${expandedPackages.includes(2) ? 'block' : 'hidden'} md:block flex-grow flex flex-col`}>
                                    <CardContent className="p-5 md:p-6 space-y-4 flex-grow">
                                        <p className="text-xs font-black uppercase tracking-widest text-safety-orange mb-4">FOR HVAC TECHNICIANS WHO WANT STEADY ENQUIRIES WITHOUT ADDING ADMIN OR MISSED CALLS.</p>
                        ...
                        <div className="max-w-xl md:max-w-5xl mx-auto">
                            <div className="mb-10">
                                <h2 className="text-3xl md:text-5xl font-black mb-4 uppercase italic leading-none tracking-tighter text-white">
                                    Ready To Get More <br /> <span className="text-safety-orange">Quality HVAC Jobs?</span>
                                </h2>
                            </div>
                            ...
                            <form onSubmit={handleSubmit} className="text-left space-y-6 bg-zinc-900/80 p-6 md:p-10 border border-white/10 backdrop-blur-sm shadow-2xl">
                                ...
                                <div className="pt-2 gap-4 flex flex-col items-center">
                                    ...
                                    <p className="text-center text-xs md:text-sm font-bold text-white/80 mt-2">
                                        You'll receive a detailed quote tailored to your HVAC business.
                                    </p>
