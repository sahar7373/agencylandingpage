...
import { CheckCircle2, Home, ArrowRight, Check, ChevronDown, ChevronUp, ShieldCheck, AlertCircle, Loader2, Search, Phone } from 'lucide-react';
...
const RooferWebsites = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            trackLead('roofer_page_form', { tier: 'primary' });
            setFormData({
                name: '',
                email: '',
                phone: '',
        ...
        <div className="min-h-screen bg-construction-charcoal text-white font-sans selection:bg-safety-orange selection:text-white">
            <Helmet>
                    ...
                    {`
                        {
                            ...
                            "audience": {
                                "@type": "Audience",
                                "name": "Roofers and Roofing Businesses in Australia"
                            }
                        }
                    `}
                </script>
                <script type="application/ld+json">{JSON.stringify({
                    ...
                    "@type": "FAQPage",
                    "mainEntity": [
                        { "@type": "Question", "name": "How long does it take to build a roofer's website?", "acceptedAnswer": { "@type": "Answer", "text": "Depending on the package, most roofer websites are live within 2-4 weeks. The Local Jobs Engine (Package 2) typically takes 2-3 weeks, while the Growth System (Package 3) with advanced features can take 3-4 weeks. We'll give you a clear timeline during the scoping call." } },
            ...
            <header className="relative pt-8 pb-24 md:pt-24 md:pb-44 border-b border-white/5 overflow-hidden">
                ...
                <div className="container mx-auto px-6 relative z-10">
                    <Breadcrumbs
                        ...
                        currentLabel="Roofer Websites"
                        currentPath="/roofer-websites"
                        className="mb-8"
                    />
                    <motion.div
                    ...
                    >
                        ...
                        <motion.p className="text-xs text-white/35 font-bold tracking-widest mb-2 -mt-4" variants={itemVariants}>
                            Roofer website design Australia — storm repairs, new builds, and tile and metal roofing that captures urgent local enquiries
                        </motion.p>
                        ...
                        <motion.p className="text-lg md:text-xl text-white/90 font-medium mb-10 leading-relaxed max-w-3xl mx-auto" variants={itemVariants}>
                            When a homeowner discovers storm damage on their roof, they're calling the roofer who looks trustworthy online — not the cheapest one. Your website makes that first impression.
                        </motion.p>
                        ...
                        <motion.div className="inline-flex items-center gap-3 bg-white/5 border border-white/10 px-6 py-3 mb-10 rounded-full md:text-sm backdrop-blur-sm" variants={itemVariants}>
                            ...
                            <p className="font-semibold text-white/80">
                                Websites built specifically for Australian roofers — <span className="text-white/40">not generic templates.</span>
                            </p>
                        </motion.div>
                        ...
                        <motion.div className="flex flex-col md:flex-row justify-center items-center gap-4 md:gap-8 mt-12 text-sm text-white/60 font-bold uppercase tracking-wider" variants={itemVariants}>
                            <div className="flex items-center gap-2">
                                ...
                                <span>Built for Australian roofers</span>
                            </div>
                            <div className="flex items-center gap-2">
                                <CheckCircle2 className="w-4 h-4 text-green-500" />
                ...
                <div className="container mx-auto px-6">
                    <div className="max-w-5xl mx-auto">
                        <h2 className="text-4xl md:text-6xl font-black mb-16 uppercase italic text-center md:text-left">
                            Why roofing businesses <br className="hidden md:block" /> need professional websites
                        </h2>
            ...
            {/* What Makes a Roofer's Website Actually Work Section */}
            <motion.section
                ...
                <div className="container mx-auto px-6">
                    <div className="max-w-6xl mx-auto">
                        <h2 className="text-4xl md:text-6xl font-black mb-4 uppercase italic text-center">
                            What Makes a Roofer's Website <span className="text-safety-orange">Actually Work</span>
                        </h2>
            ...
            <div className="py-12 text-center bg-safety-orange/5 border-y border-safety-orange/20">
                <p className="text-white/60 font-bold uppercase tracking-widest text-sm mb-4">
                    Ready to see what a roofer-specific website looks like?
                </p>
                <a href="#contact">
                ...
                <div className="container mx-auto px-6">
                    <div className="max-w-4xl mx-auto">
                        <h2 className="text-4xl md:text-6xl font-black mb-16 uppercase italic text-center">
                            Common Questions <span className="text-safety-orange">From Roofers</span>
                        </h2>

                        <motion.div className="space-y-6" variants={containerVariants}>
                            {[
                                {
                                    question: "How long does it take to build a roofer's website?",
                                    answer: "Depending on the package, most roofer websites are live within 2-4 weeks. The Local Jobs Engine (Package 2) typically takes 2-3 weeks, while the Growth System (Package 3) with advanced features can take 3-4 weeks. We'll give you a clear timeline during the scoping call."
                                },
                                {
                                    question: "Will my roofing website show up on Google?",
                    ...
                    <div className="max-w-6xl mx-auto">
                        <div className="text-center mb-12">
                            <div className="inline-flex items-center gap-2 bg-safety-orange px-4 py-2 mb-6">
                                <span className="text-[10px] font-black uppercase tracking-widest text-white">✓ Real Client Result — Roofer</span>
                            </div>
                            <h2 className="text-4xl md:text-6xl font-black uppercase italic mb-4">
                                See What We Built for a <span className="text-safety-orange">Real Roofer</span>
                            </h2>
                        ...
                        >
                            <div className="grid md:grid-cols-2">
                                <div className="relative h-[280px] md:h-auto min-h-[420px] overflow-hidden">
                                    <img
                                        src="/projects/SWRP/swrp-homepage.png"
                                        alt="SWRP roofing website — NSW roofer case study by Your Trade Partner"
                                ...
                                <div className="p-8 md:p-12 flex flex-col justify-between bg-white">
                                    <div>
                                        ...
                                        <p className="text-zinc-800 font-bold text-lg md:text-xl leading-relaxed mb-6 italic">
                                            Building a scaleable roofing business required more than just a website; we needed a full digital infrastructure. From custom SWMS to professional roof reporting, the system now handles our growth without the typical operational headaches.
                                        </p>
                                        <div className="flex items-center gap-3 mb-10">
                                            <div className="w-8 h-0.5 bg-safety-orange flex-shrink-0" />
                                            <span className="text-xs font-black uppercase tracking-widest text-zinc-400">SWRP — NSW</span>
                                        </div>
                                    </div>
                                    ...
                                    <div className="mb-8">
                                        ...
                                        <ul className="space-y-2.5">
                                            {[
                                                "14+ page website with full brand identity",
                                                "Custom SWMS (Safe Work Method Statements)",
                                                "Professional roof report templates",
                                                "Custom email & lead capture system"
                                            ].map((item, i) => (
                            ...
                            <Card className="bg-white/5 border-2 border-white/10 rounded-none h-full flex flex-col">
                                ...
                                <div className={`${expandedPackages.includes(1) ? 'block' : 'hidden'} md:block flex-grow flex flex-col`}>
                                    <CardContent className="p-5 md:p-6 space-y-4 flex-grow">
                                        <p className="text-xs font-black uppercase tracking-widest text-safety-orange mb-4">FOR ROOFERS WHO WANT TO LOOK PROFESSIONAL AND STOP LOSING JOBS DUE TO WEAK ONLINE PRESENCE.</p>
                        ...
                        <motion.div whileHover={hoverLift} className="h-full">
                            <Card className="bg-white/5 border-2 border-white/10 rounded-none h-full flex flex-col">
                                ...
                                <div className={`${expandedPackages.includes(2) ? 'block' : 'hidden'} md:block flex-grow flex flex-col`}>
                                    <CardContent className="p-5 md:p-6 space-y-4 flex-grow">
                                        <p className="text-xs font-black uppercase tracking-widest text-safety-orange mb-4">FOR ROOFERS WHO WANT STEADY ENQUIRIES WITHOUT ADDING ADMIN OR MISSED CALLS.</p>
                        ...
                        <div className="max-w-xl md:max-w-5xl mx-auto">
                            <div className="mb-10">
                                <h2 className="text-3xl md:text-5xl font-black mb-4 uppercase italic leading-none tracking-tighter text-white">
                                    Ready To Get More <br /> <span className="text-safety-orange">Quality Roofing Jobs?</span>
                                </h2>
                            </div>
                            ...
                            <form onSubmit={handleSubmit} className="text-left space-y-6 bg-zinc-900/80 p-6 md:p-10 border border-white/10 backdrop-blur-sm shadow-2xl">
                                ...
                                <div className="pt-2 gap-4 flex flex-col items-center">
                                    ...
                                    <p className="text-center text-xs md:text-sm font-bold text-white/80 mt-2">
                                        You'll receive a detailed quote tailored to your roofing business.
                                    </p>
