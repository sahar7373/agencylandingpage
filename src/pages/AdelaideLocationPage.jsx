...
const AdelaideLocationPage = () => {
    ...
    const adelaideSuburbs = [
        'Adelaide CBD', 'North Adelaide', 'Norwood', 'Burnside', 'Mitcham',
        'Glenelg', 'Marion', 'Prospect', 'Henley Beach', 'Semaphore',
        'Port Adelaide', 'Salisbury', 'Tea Tree Gully', 'Modbury', 'Golden Grove',
        'Campbelltown', 'Magill', 'Aldinga', 'McLaren Vale', 'Morphett Vale',
        'Seaford', 'Noarlunga', 'Stirling', 'Blackwood', 'Plympton',
        'Edwardstown', 'Thebarton', 'Unley', 'Hahndorf', 'Mount Barker'
    ];
    ...
    return (
        <div className="min-h-screen bg-construction-charcoal text-white font-sans selection:bg-safety-orange selection:text-white">
            ...
            <Helmet>
                <title>Tradie Website Design Adelaide | Get More Local Jobs | Your Trade Partner</title>
                <meta name="description" content="Adelaide-based website design and digital systems for tradies. We help SA trade businesses get found on Google, capture every enquiry, and stop losing jobs to competitors." />
                <link rel="canonical" href="https://yourtradepartner.com.au/tradie-website-design-adelaide" />
                <meta name="robots" content="index, follow" />

                <meta property="og:type" content="website" />
                <meta property="og:title" content="Tradie Website Design Adelaide | Your Trade Partner" />
                <meta property="og:description" content="Adelaide-based website design and digital systems for tradies. Get found on Google, capture every enquiry, stop losing jobs." />
                <meta property="og:url" content="https://yourtradepartner.com.au/tradie-website-design-adelaide" />
                ...
                <script type="application/ld+json">
                    {JSON.stringify({
                        ...
                        "@type": "Service",
                        "serviceType": "Tradie Website Design Adelaide",
                        "name": "Tradie Website Design Adelaide",
                        "description": "Professional website design and digital marketing systems for trade businesses in Adelaide, South Australia. We help plumbers, electricians, roofers, builders and all trades get found online and capture more local jobs.",
                        "provider": {
                            "@type": "LocalBusiness",
                ...
                <script type="application/ld+json">{JSON.stringify({
                    ...
                    "@type": "FAQPage",
                    "mainEntity": [
                        { "@type": "Question", "name": "Do I need a website if I already get work by word of mouth in Adelaide?", "acceptedAnswer": { "@type": "Answer", "text": "Word of mouth gets you repeat work — but it doesn't reach the customer who's just moved to Mitcham, needs a plumber, and searches Google at 8pm. A professional website and Google Business Profile means you're the tradie they find, even without a referral. It also makes your word-of-mouth referrals more likely to call — they look you up first." } },
            ...
            <header className="relative pt-8 pb-24 md:pt-24 md:pb-44 border-b border-white/5 overflow-hidden">
                ...
                <div className="container mx-auto px-6 relative z-10">
                    <Breadcrumbs
                        ...
                        currentLabel="Tradie Website Design Adelaide"
                        currentPath="/tradie-website-design-adelaide"
                        className="mb-8"
                    />
                    <motion.div
                    ...
                    >
                        ...
                        <motion.p className="text-xs text-white/30 font-bold tracking-widest mb-8 -mt-2" variants={itemVariants}>
                            Tradie website design Adelaide — built by an Adelaide-based team who knows the SA trade market
                        </motion.p>
                        ...
                        <motion.p className="text-lg md:text-xl text-white/90 font-medium mb-10 leading-relaxed max-w-3xl mx-auto" variants={itemVariants}>
                            Adelaide homeowners search Google before they call. If your business doesn't show up, look professional, and make it easy to get in touch — they're calling someone else before you even know the job existed.
                        </motion.p>
                        ...
                        <motion.div className="inline-flex items-center gap-3 bg-white/5 border border-white/10 px-6 py-3 mb-10 rounded-full md:text-sm backdrop-blur-sm" variants={itemVariants}>
                            ...
                            <p className="font-semibold text-white/80">
                                Adelaide-based team — <span className="text-white/40">we know the SA market, not just the theory.</span>
                            </p>
                        </motion.div>
                        ...
                        <motion.div className="flex flex-col items-center gap-4" variants={itemVariants}>
                            ...
                            <p className="text-[10px] md:text-xs text-white/40 uppercase tracking-widest font-bold">
                                No obligation · Adelaide-based · Results or we don't take your money
                            </p>
                        </motion.div>
                        ...
                        <motion.div className="flex flex-col md:flex-row justify-center items-center gap-4 md:gap-8 mt-12 text-sm text-white/60 font-bold uppercase tracking-wider" variants={itemVariants}>
                            <div className="flex items-center gap-2">
                                ...
                                <span>Adelaide-based team</span>
                            </div>
                            <div className="flex items-center gap-2">
                                <CheckCircle2 className="w-4 h-4 text-green-500" />
                                <span>Built for SA trade businesses</span>
                            </div>
                            <div className="flex items-center gap-2">
                                <CheckCircle2 className="w-4 h-4 text-green-500" />
                ...
                <div className="container mx-auto px-6">
                    <div className="max-w-5xl mx-auto">
                        <h2 className="text-4xl md:text-6xl font-black mb-4 uppercase italic text-center md:text-left">
                            What's happening to Adelaide tradies<br className="hidden md:block" /> without a strong online presence
                        </h2>
                        <p className="text-white/40 font-bold uppercase tracking-widest mb-16 text-sm">
                            The SA market is competitive. The tradies who show up online are taking jobs from the ones who don't.
                        </p>
                        ...
                        <motion.div className="grid md:grid-cols-2 gap-8 mb-16" variants={containerVariants} initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-50px" }}>
                            {[
                                {
                                    title: "Norwood homeowner, 8pm — searches Google, calls the first result",
                                    detail: "That tradie isn't necessarily better than you. They just show up. If your Google Business Profile is incomplete, your website is outdated, or you don't appear in local results — you're invisible to that job before it even starts."
                                },
                                {
                                    title: "Your competitor in Mitcham is getting the calls you should be getting",
                                    detail: "The Adelaide trade market is small enough that your competition is probably one suburb over. If they have a professional website, Google reviews, and a click-to-call button — and you don't — they're taking work that's geographically yours."
                                },
                                {
                                    title: "Word of mouth doesn't reach new suburbs",
                                    detail: "Adelaide grows. People move to Seaford, Golden Grove, Mount Barker. They don't know any local tradies. They go straight to Google. Without an online presence, those jobs don't exist for you — even if you're the best in your trade."
                                },
                                {
                                    title: "Missed calls at 7am are missed jobs — permanently",
                                    detail: "SA tradies start early. So do homeowners with emergencies. When someone calls at 7am about a burst pipe in Glenelg and gets voicemail — they call the next one on Google. An enquiry capture system means you get that job even when you're already on site."
                                }
                            ].map((item, i) => (
                        ...
                        <div className="text-center md:text-right">
                            <p className="text-3xl md:text-5xl font-black italic uppercase leading-tight">
                                You're not losing Adelaide jobs on price —<br />
                ...
                <div className="container mx-auto px-6">
                    <div className="max-w-6xl mx-auto">
                        <h2 className="text-4xl md:text-6xl font-black mb-4 uppercase italic text-center">
                            What We Build for <span className="text-safety-orange">Adelaide Tradies</span>
                        </h2>
                        <p className="text-white/40 text-center font-bold uppercase tracking-widest mb-16">
                            Not generic marketing. Systems built for how the SA trade market actually works.
                        </p>
                            ...
                            {[
                                {
                                    ...
                                    features: [
                                        ...
                                        "Suburb pages targeting your Adelaide service area",
                                ...
                                },
                                {
                                    ...
                                    features: [
                                        ...
                                        "Targeting Adelaide suburbs you actually work in",
                ...
                <div className="container mx-auto px-6">
                    <div className="max-w-5xl mx-auto text-center">
                        <h2 className="text-4xl md:text-6xl font-black mb-4 uppercase italic">
                            Serving Tradies Across <span className="text-safety-orange">Greater Adelaide</span>
                        </h2>
                        <p className="text-white/40 font-bold uppercase tracking-widest mb-12 text-sm">
                            We work with trade businesses across the full Adelaide metro — north, south, east, west, and Hills.
                        </p>

                        <div className="flex flex-wrap justify-center gap-3">
                            {adelaideSuburbs.map((suburb, i) => (
                                <span
                                    key={i}
                        ...
                        <p className="text-white/30 text-xs font-bold uppercase tracking-widest mt-8">
                            Not in this list? Get in touch — if you're in SA, we can help.
                        </p>
                        <a href="/resources/suburb-seo-for-adelaide-tradies" className="mt-8 inline-flex items-center gap-4 bg-white/5 border border-safety-orange/20 px-6 py-4 text-left max-w-xl w-full hover:border-safety-orange/50 transition-colors group">
                            ...
                            <div>
                                ...
                                <p className="text-sm font-black uppercase text-white group-hover:text-safety-orange transition-colors">Adelaide Suburb SEO for Tradies: Which Areas Are Worth Targeting? →</p>
                            </div>
                        </a>
                    </div>
                </div>
                ...
                <div className="container mx-auto px-6">
                    <div className="max-w-4xl mx-auto">
                        <h2 className="text-4xl md:text-6xl font-black mb-16 uppercase italic text-center">
                            Questions from <span className="text-safety-orange">Adelaide Tradies</span>
                        </h2>
                        ...
                        <motion.div className="space-y-6" variants={containerVariants} initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-50px" }}>
                            {[
                                {
                                    question: "Do I need a website if I already get work by word of mouth in Adelaide?",
                                    answer: "Word of mouth gets you repeat work — but it doesn't reach the customer who's just moved to Mitcham, needs a plumber, and searches Google at 8pm. A professional website and Google Business Profile means you're the tradie they find, even without a referral. It also makes your word-of-mouth referrals more likely to call — they look you up first."
                                },
                                {
                                    question: "How long before I show up in Adelaide search results?",
                                    answer: "A properly set up Google Business Profile can appear in local Adelaide results within days to weeks. Your website's SEO takes 3–6 months to build real ranking momentum. If you need Adelaide jobs faster, we can include Google Ads management to get calls coming in within days of launch."
                                },
                                {
                                    question: "Are you Adelaide-based?",
                                    answer: "Yes. Your Trade Partner is based in Adelaide, SA. We understand the SA trade market — the suburbs, the competition, and how Adelaide homeowners search for tradies. You're not dealing with someone in Sydney guessing at your local market."
                                },
                                {
                                    question: "Can you build websites for any trade in Adelaide?",
                                    answer: "Yes. We've built digital systems for plumbers, electricians, roofers, builders, HVAC, landscapers, painters, concreters, and carpenters across the Adelaide metro and Hills. Each trade has different trust signals and search behaviour — we know the difference."
                                },
                                {
                                    question: "What does a tradie website cost in Adelaide?",
                ...
                <div className="container mx-auto px-6">
                    <div className="max-w-2xl mx-auto">
                        ...
                        <p className="text-white/40 text-center font-bold uppercase tracking-widest mb-12 text-sm">
                            Tell us your trade and we'll show you exactly what's costing you Adelaide jobs right now.
                        </p>
                        ...
                        {formStatus === 'success' ? (
                            ...
                            <form onSubmit={handleSubmit} className="space-y-4">
                                ...
                                <div>
                                    <label className="text-[10px] font-black uppercase tracking-widest text-white/40 block mb-2">Adelaide Suburb / Area</label>
                                    <input
                                        type="text"
                                        name="location"
                                        ...
                                        onChange={handleInputChange}
                                        className="w-full bg-white/5 border border-white/10 text-white px-4 py-3 text-sm font-bold focus:outline-none focus:border-safety-orange/50 transition-colors"
                                        placeholder="e.g. Norwood, Marion, Glenelg"
                                    />
                                </div>
...
export default AdelaideLocationPage;
