...
const SydneyLocationPage = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            trackLead('sydney_page_form', { tier: 'primary' });
    ...
    const sydneySuburbs = [
        'Parramatta', 'Liverpool', 'Blacktown', 'Penrith', 'Campbelltown',
        'Bankstown', 'Sutherland', 'Cronulla', 'Miranda', 'Chatswood',
        'Hornsby', 'Castle Hill', 'Ryde', 'Epping', 'Strathfield',
        'Burwood', 'Ashfield', 'Marrickville', 'Newtown', 'Bondi Junction',
        'Manly', 'Dee Why', 'Brookvale', 'Mosman', 'North Sydney',
        'Balmain', 'Leichhardt', 'Glebe', 'Oran Park', 'Camden'
    ];
    ...
    const successProjects = [
        {
            ...
            images: { preview: "/projects/Rovinas/homepage-rovina.png", homepage: "/projects/Rovinas/homepage-rovina.png" },
        ...
        },
        {
            ...
            images: { preview: "/projects/zjc/homepage.png", homepage: "/projects/zjc/homepage.png", service: "/projects/zjc/service.png", serviceLabel: "Bathroom Renovation Showcase", work: "/projects/zjc/work.png" },
        ...
        },
        {
            ...
            images: { preview: "/projects/SWRP/swrp-homepage.png", homepage: "/projects/SWRP/swrp-homepage.png", service: "/projects/SWRP/swrp-service.png", serviceLabel: "Roof Reconstruction Showcase", work: "/projects/SWRP/swrp-work.png" },
    ...
    return (
        <div className="min-h-screen bg-construction-charcoal text-white font-sans selection:bg-safety-orange selection:text-white">
            ...
            <Helmet>
                <title>Tradie Website Design Sydney | Get More Local Jobs | Your Trade Partner</title>
                <meta name="description" content="Sydney tradie website design and digital systems that get you found on Google, capture every enquiry, and stop you losing jobs to competitors across the Greater Sydney basin." />
                <link rel="canonical" href="https://yourtradepartner.com.au/tradie-website-design-sydney" />
                <meta name="robots" content="index, follow" />

                <meta property="og:type" content="website" />
                <meta property="og:title" content="Tradie Website Design Sydney | Your Trade Partner" />
                <meta property="og:description" content="Sydney tradie website design and digital systems. Get found on Google, capture every enquiry, stop losing jobs to competitors." />
                <meta property="og:url" content="https://yourtradepartner.com.au/tradie-website-design-sydney" />
                ...
                <script type="application/ld+json">
                    {JSON.stringify({
                        ...
                        "@type": "Service",
                        "serviceType": "Tradie Website Design Sydney",
                        "name": "Tradie Website Design Sydney",
                        "description": "Professional website design and digital marketing systems for trade businesses in Sydney, NSW. We help plumbers, electricians, roofers, builders and all trades get found online and capture more local jobs.",
                        "provider": {
                            "@type": "LocalBusiness",
                ...
                <script type="application/ld+json">{JSON.stringify({
                    ...
                    "@type": "FAQPage",
                    "mainEntity": [
                        { "@type": "Question", "name": "Do I need a website if I already get work by word of mouth in Sydney?", "acceptedAnswer": { "@type": "Answer", "text": "Word of mouth works — until it stops. It doesn't reach the homeowner who just moved to Oran Park, needs a plumber, and searches Google at 8pm. A professional website and Google Business Profile means you're the tradie they find, even without a referral. Your word-of-mouth leads also check you out online before they call — and if you look weak, they call someone else." } },
                        { "@type": "Question", "name": "How long before I show up in Sydney search results?", "acceptedAnswer": { "@type": "Answer", "text": "A properly set up Google Business Profile can appear in local results within days to weeks. Your website's SEO takes 3–6 months to build real ranking momentum in Sydney's competitive market. If you need jobs faster, we can include Google Ads management to get calls coming in within days of launch." } },
                        { "@type": "Question", "name": "Sydney is huge — can you target my specific area?", "acceptedAnswer": { "@type": "Answer", "text": "Yes. We build suburb-specific pages and SEO strategies targeting exactly where you work — whether that's the Hills District, Inner West, Northern Beaches, South-West, or anywhere in between. You don't need to rank across all of Sydney, just in the suburbs that send you work." } },
                        { "@type": "Question", "name": "Can you build websites for any trade in Sydney?", "acceptedAnswer": { "@type": "Answer", "text": "Yes. We've built digital systems for plumbers, electricians, roofers, builders, HVAC, landscapers, painters, concreters, and carpenters across Greater Sydney. Each trade has different trust signals and search behaviour — we know the difference and build accordingly." } },
                        { "@type": "Question", "name": "What does a tradie website cost in Sydney?", "acceptedAnswer": { "@type": "Answer", "text": "Our Trade-Ready Online Setup starts at $1,900 one-time + $299/quarter for hosting and support. The Local Jobs Engine (website + SEO + Google Business Profile) is $3,900 + $399/quarter. Full Growth System (website + automation + ads) starts from $7,900. Every project is scoped before you commit — no surprises." } }
                    ]
                })}</script>
            </Helmet>
            ...
            <header className="relative pt-8 pb-24 md:pt-24 md:pb-44 border-b border-white/5 overflow-hidden">
                ...
                <div className="container mx-auto px-6 relative z-10">
                    <Breadcrumbs
                        ...
                        currentLabel="Tradie Website Design Sydney"
                        currentPath="/tradie-website-design-sydney"
                        className="mb-8"
                    />
                    <motion.div
                    ...
                    >
                        ...
                        <motion.h1 className="text-[48px] md:text-[80px] font-black leading-[0.9] mb-4 uppercase italic" variants={itemVariants}>
                            Sydney Tradies:<br />
                            <span className="text-safety-orange">Stop Losing Jobs Online</span>
                        </motion.h1>

                        <motion.p className="text-xs text-white/30 font-bold tracking-widest mb-8 -mt-2" variants={itemVariants}>
                            Tradie website design Sydney — built for the most competitive trade market in Australia
                        </motion.p>
                        ...
                        <motion.p className="text-lg md:text-xl text-white/90 font-medium mb-10 leading-relaxed max-w-3xl mx-auto" variants={itemVariants}>
                            Sydney homeowners search Google before they call. With thousands of tradies competing for the same jobs, if you don't show up, look professional, and make it easy to get in touch — they've already called someone else before you even know the job existed.
                        </motion.p>
                        ...
                        <motion.div className="inline-flex items-center gap-3 bg-white/5 border border-white/10 px-6 py-3 mb-10 rounded-full md:text-sm backdrop-blur-sm" variants={itemVariants}>
                            ...
                            <p className="font-semibold text-white/80">
                                Built for NSW trade businesses — <span className="text-white/40">suburb-specific strategy, not a generic template.</span>
                            </p>
                        </motion.div>
                        ...
                        <motion.div className="flex flex-col items-center gap-4" variants={itemVariants}>
                            ...
                            <p className="text-[10px] md:text-xs text-white/40 uppercase tracking-widest font-bold">
                                No obligation · Sydney-focused strategy · Results or we don't take your money
                            </p>
                        </motion.div>
                        ...
                        <motion.div className="flex flex-col md:flex-row justify-center items-center gap-4 md:gap-8 mt-12 text-sm text-white/60 font-bold uppercase tracking-wider" variants={itemVariants}>
                            <div className="flex items-center gap-2">
                                ...
                                <span>NSW trade specialists</span>
                            </div>
                            <div className="flex items-center gap-2">
                                <CheckCircle2 className="w-4 h-4 text-green-500" />
                                <span>Suburb-targeted SEO</span>
                            </div>
                            <div className="flex items-center gap-2">
                                <CheckCircle2 className="w-4 h-4 text-green-500" />
                ...
                <div className="container mx-auto px-6">
                    <div className="max-w-5xl mx-auto">
                        <h2 className="text-4xl md:text-6xl font-black mb-4 uppercase italic text-center md:text-left">
                            What's happening to Sydney tradies<br className="hidden md:block" /> without a strong online presence
                        </h2>
                        <p className="text-white/40 font-bold uppercase tracking-widest mb-16 text-sm">
                            Sydney has more tradies than anywhere in Australia. If you're not visible online, you're invisible to the job.
                        </p>
                        ...
                        <motion.div className="grid md:grid-cols-2 gap-8 mb-16" variants={containerVariants} initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-50px" }}>
                            {[
                                {
                                    title: "Parramatta homeowner, 7pm — searches Google, calls the first result",
                                    detail: "That tradie isn't better than you. They just show up first. Sydney homeowners don't scroll past the top three results. If your Google Business Profile is thin, your website looks dated, or you don't rank for your suburb — that job goes to a competitor before you know it existed."
                                },
                                {
                                    title: "You're stuck in traffic while your competitor in Sutherland is getting the calls",
                                    detail: "Sydney tradies lose an hour to commute and another to phone tag. The tradies cleaning up are the ones with a system: an enquiry comes in, a response goes out automatically, the job is booked. You can be stuck on the M5 and still win the work — if you have the right setup."
                                },
                                {
                                    title: "The South-West growth corridor is full of homeowners who don't know any tradies yet",
                                    detail: "Oran Park, Edmondson Park, Leppington — tens of thousands of new homes, all owned by people who don't have a go-to tradie yet. They search Google for everything. If you're not showing up in these growth suburbs, you're leaving a massive pipeline of new work untouched."
                                },
                                {
                                    title: "Missed calls during a busy run are missed jobs — forever",
                                    detail: "Sydney's trade market doesn't wait. If someone calls about a hot water system in Castle Hill and gets voicemail, they immediately call the next result. You can be the best plumber in the Hills District and still lose to a worse tradie who just has a callback system. You need automation so you never miss the job."
                                }
                            ].map((item, i) => (
                        ...
                        <div className="text-center md:text-right">
                            <p className="text-3xl md:text-5xl font-black italic uppercase leading-tight">
                                You're not losing Sydney jobs on price —<br />
                ...
                <div className="container mx-auto px-6">
                    <div className="max-w-6xl mx-auto">
                        <h2 className="text-4xl md:text-6xl font-black mb-4 uppercase italic text-center">
                            What We Build for <span className="text-safety-orange">Sydney Tradies</span>
                        </h2>
                        <p className="text-white/40 text-center font-bold uppercase tracking-widest mb-16">
                            Not generic marketing. Systems built for how the NSW trade market actually works.
                        </p>
                        ...
                        >
                            {[
                                {
                                    icon: "🌐",
                                    title: "Trade-Ready Website",
                                    features: [
                                        "Fast-loading, mobile-first (most searches are phone)",
                                        "Suburb pages targeting your Sydney service area",
                                        "Click-to-call on every page",
                                        "Trust signals: licences, insurance, photos",
                                        "Quote forms that send directly to your phone",
                                ...
                                },
                                {
                                    ...
                                    features: [
                                        ...
                                        "Targeting Sydney suburbs you actually work in",
                                        "Local citations submitted to AU directories",
                                        "Review strategy to build your rating fast",
                                        "Keyword targeting for your specific trade + area",
                                ...
                                },
                                {
                                    ...
                                    features: [
                                        "Missed-call text-back so no job slips",
                                        "After-hours enquiry capture (jobs don't stop at 5pm)",
                                        "Instant SMS notification when a new job comes in",
                                        "AI enquiry handling for common questions",
                                        "Enquiry routing — right job to right person",
                                        "Works while you're on the tools"
                                    ]
                                }
                            ].map((item, i) => (
                                <motion.div
                ...
                <div className="container mx-auto px-6">
                    <div className="max-w-5xl mx-auto text-center">
                        <h2 className="text-4xl md:text-6xl font-black mb-4 uppercase italic">
                            Serving Tradies Across <span className="text-safety-orange">Greater Sydney</span>
                        </h2>
                        <p className="text-white/40 font-bold uppercase tracking-widest mb-12 text-sm">
                            We work with trade businesses across the full Sydney basin — Inner West, Hills District, South-West, Northern Beaches, and beyond.
                        </p>
                        ...
                        <div className="flex flex-wrap justify-center gap-3">
                            {sydneySuburbs.map((suburb, i) => (
                                <span
                                    key={i}
                                    className="bg-white/5 border border-white/10 px-4 py-2 text-xs font-black uppercase tracking-widest text-white/60 hover:border-safety-orange/40 hover:text-white/90 transition-colors"
                                >
                                    {suburb}
                                </span>
                            ))}
                        ...
                        <p className="text-white/30 text-xs font-bold uppercase tracking-widest mt-8">
                            Not in this list? Get in touch — if you're in NSW, we can help.
                        </p>
                        <a href="/resources/suburb-seo-for-sydney-roofers" className="mt-8 inline-flex items-center gap-4 bg-white/5 border border-safety-orange/20 px-6 py-4 text-left max-w-xl w-full hover:border-safety-orange/50 transition-colors group">
                            ...
                            <div>
                                ...
                                <p className="text-sm font-black uppercase text-white group-hover:text-safety-orange transition-colors">Sydney Suburb SEO for Roof Tilers & Metal Roofers: Where the Jobs Are →</p>
                            </div>
                        </a>
                    </div>
                </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 lg:gap-12">
                            {successProjects.map((project) => (
                                <motion.div
                                    ...
                                    transition={{ duration: 0.7, ease: [0.22, 1, 0.36, 1] }}
                                    className={`group relative overflow-hidden rounded-sm hover:border-safety-orange/50 transition-all duration-500 flex flex-col ${project.isLight ? "bg-white border border-transparent shadow-xl" : "bg-white/5 border border-white/10"}`}
                                >
                                    <motion.div
                                        initial={{ opacity: 0 }}
                                    ...
                                    <div className="p-6 md:p-8 flex flex-col flex-grow">
                                        {project.website ? (
                                            <a href={project.website} target="_blank" rel="noopener noreferrer" className={`text-2xl font-black uppercase italic mb-4 hover:text-safety-orange transition-colors ${project.isLight ? "text-zinc-900" : "text-white"}`}>
                                                <h3>{project.title}</h3>
                                            </a>
                                        ) : (
                                        ...
                                        <div className="flex flex-wrap gap-2 mb-8">
                                            {project.tags.map((tag, i) => (
                                                <span key={i} className={`text-[9px] font-black uppercase tracking-widest px-3 py-1.5 border rounded-sm ${project.isLight ? "bg-zinc-100 text-zinc-600 border-zinc-200" : "bg-white/10 text-white border-white/20"}`}>
                                                    {tag}
                                                </span>
                                            ))}
                                        </div>
                                        ...
                                        <div className="mt-auto flex items-center gap-3 flex-wrap">
                                            <Button
                                                onClick={() => { setSelectedProject(project); setIsCaseStudyModalOpen(true); }}
                                                className={`rounded-none px-6 py-5 text-[11px] font-black uppercase tracking-widest shadow-xl transition-all ${project.isLight ? "bg-black text-white hover:bg-zinc-800" : "bg-white text-black hover:bg-white/90"}`}
                                            >
                                                See More
                                            </Button>
                                            {project.video && (
                                                <button
                                                    onClick={() => { setSelectedProject(project); setIsVideoModalOpen(true); }}
                ...
                <div className="container mx-auto px-6">
                    <div className="max-w-4xl mx-auto">
                        <h2 className="text-4xl md:text-6xl font-black mb-16 uppercase italic text-center">
                            Questions from <span className="text-safety-orange">Sydney Tradies</span>
                        </h2>
                        ...
                        <motion.div className="space-y-6" variants={containerVariants} initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-50px" }}>
                            {[
                                {
                                    question: "Do I need a website if I already get work by word of mouth in Sydney?",
                                    answer: "Word of mouth works — until it stops. It doesn't reach the homeowner who just moved to Oran Park, needs a plumber, and searches Google at 8pm. A professional website and Google Business Profile means you're the tradie they find, even without a referral. Your word-of-mouth leads also check you out online before they call — and if you look weak, they call someone else."
                                },
                                {
                                    question: "How long before I show up in Sydney search results?",
                                    answer: "A properly set up Google Business Profile can appear in local Sydney results within days to weeks. Your website's SEO takes 3–6 months to build real ranking momentum in Sydney's competitive market. If you need jobs faster, we can include Google Ads management to get calls coming in within days of launch."
                                },
                                {
                                    question: "Sydney is huge — can you target my specific area?",
                                    answer: "Yes. We build suburb-specific pages and SEO strategies targeting exactly where you work — whether that's the Hills District, Inner West, Northern Beaches, South-West, or anywhere in between. You don't need to rank across all of Sydney, just in the suburbs that send you work."
                                },
                                {
                                    question: "Can you build websites for any trade in Sydney?",
                                    answer: "Yes. We've built digital systems for plumbers, electricians, roofers, builders, HVAC, landscapers, painters, concreters, and carpenters across Greater Sydney. Each trade has different trust signals and search behaviour — we know the difference and build accordingly."
                                },
                                {
                                    question: "What does a tradie website cost in Sydney?",
                                    answer: "Our Trade-Ready Online Setup starts at $1,900 one-time + $299/quarter for hosting and support. The Local Jobs Engine (website + SEO + Google Business Profile) is $3,900 + $399/quarter. Full Growth System starts from $7,900. Every project is scoped before you commit — no surprises."
                                }
                            ].map((faq, i) => {
            ...
            <motion.section
                id="contact"
                className="py-24 md:py-32 bg-black/40"
                variants={sectionVariants}
                initial="hidden"
                whileInView="visible"
                viewport={{ once: true, margin: "-50px" }}
            >
                <div className="container mx-auto px-6">
                    <div className="max-w-2xl mx-auto">
                        <h2 className="text-4xl md:text-6xl font-black mb-4 uppercase italic text-center">
                            Get a Free <span className="text-safety-orange">Website Audit</span>
                        </h2>
                        <p className="text-white/40 text-center font-bold uppercase tracking-widest mb-12 text-sm">
                            Tell us your trade and we'll show you exactly what's costing you Sydney jobs right now.
                        </p>

                        {formStatus === 'success' ? (
                            <div className="text-center py-16 border border-safety-orange/20 bg-safety-orange/5">
                                <CheckCircle2 className="w-16 h-16 text-safety-orange mx-auto mb-6" />
                                <h3 className="text-2xl font-black uppercase mb-4">We'll be in touch shortly.</h3>
                                <p className="text-white/60 font-bold">Expect a call or email within one business day.</p>
                            </div>
                        ) : (
                            <form onSubmit={handleSubmit} className="space-y-4">
                                <div className="grid grid-cols-2 gap-4">
                                    <div>
                                        <label className="text-[10px] font-black uppercase tracking-widest text-white/40 block mb-2">Your Name *</label>
                                        <input
                                            type="text"
                                            name="name"
                                            required
                                            ...
                                            className="w-full bg-white/5 border border-white/10 text-white px-4 py-3 text-sm font-bold focus:outline-none focus:border-safety-orange/50 transition-colors"
                                            placeholder="First name"
                                        />
                                    </div>
                                    <div>
                                        <label className="text-[10px] font-black uppercase tracking-widest text-white/40 block mb-2">Phone *</label>
                                        <input
                                            type="tel"
                                            name="phone"
                                            required
                                        ...
                                        />
                                        {phoneError && <p className="text-red-400 text-xs mt-1 font-bold">{phoneError}</p>}
                                    </div>
                                </div>
                                ...
                                <div className="grid grid-cols-2 gap-4">
                                    <div>
                                        <label className="text-[10px] font-black uppercase tracking-widest text-white/40 block mb-2">Business Name</label>
                                        <input
                                            type="text"
                                            name="business"
                                    ...
                                    <div>
                                        <label className="text-[10px] font-black uppercase tracking-widest text-white/40 block mb-2">Your Trade *</label>
                                        <select
                                            name="trade"
                                            required
                                            ...
                                            className="w-full bg-white/5 border border-white/10 text-white px-4 py-3 text-sm font-bold focus:outline-none focus:border-safety-orange/50 transition-colors"
                                        >
                                            <option value="" className="bg-construction-charcoal">Select trade</option>
                                ...
                                <div>
                                    <label className="text-[10px] font-black uppercase tracking-widest text-white/40 block mb-2">Sydney Suburb / Area</label>
                                    <input
                                        type="text"
                                        name="location"
                                        ...
                                        onChange={handleInputChange}
                                        className="w-full bg-white/5 border border-white/10 text-white px-4 py-3 text-sm font-bold focus:outline-none focus:border-safety-orange/50 transition-colors"
                                        placeholder="e.g. Parramatta, Sutherland, Manly"
                                    />
                                </div>

                                <div>
                                    <label className="text-[10px] font-black uppercase tracking-widest text-white/40 block mb-2">Anything else we should know?</label>
                                    <textarea
                                        name="message"
                                        rows={3}
                                        value={formData.message}
                                        onChange={handleInputChange}
                                        className="w-full bg-white/5 border border-white/10 text-white px-4 py-3 text-sm font-bold focus:outline-none focus:border-safety-orange/50 transition-colors resize-none"
                                ...
                                <Button
                                    ...
                                    className="w-full bg-safety-orange hover:bg-safety-orange-hover text-white rounded-none py-6 text-lg font-black uppercase tracking-widest"
                                >
                                    {formStatus === 'submitting' ? (
                                        <><Loader2 className="w-5 h-5 animate-spin mr-2" />Sending...</>
                                    ) : (
                                        <>Get My Free Audit <ArrowRight className="ml-2 w-5 h-5" /></>
                                    )}
                                </Button>

                                <p className="text-[10px] text-white/30 text-center font-bold uppercase tracking-widest">
                                    No spam. No obligation. We'll call or email within one business day.
                                </p>
                            </form>
                        )}
...
export default SydneyLocationPage;
