...
const MelbourneLocationPage = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            trackLead('melbourne_page_form', { tier: 'primary' });
        } catch (error) { console.error("Form submission error:", error); setFormStatus('idle'); }
    };

    const melbourneSuburbs = [
        'Richmond', 'Fitzroy', 'Collingwood', 'Carlton', 'South Yarra',
        'Prahran', 'St Kilda', 'Port Melbourne', 'Footscray', 'Sunshine',
        'St Albans', 'Werribee', 'Dandenong', 'Frankston', 'Ringwood',
        'Doncaster', 'Box Hill', 'Glen Waverley', 'Moorabbin', 'Cheltenham',
        'Brighton', 'Hawthorn', 'Camberwell', 'Knox', 'Pakenham',
        'Cranbourne', 'Tarneit', 'Hoppers Crossing', 'Sunbury', 'Epping'
    ];
    ...
    return (
        <div className="min-h-screen bg-construction-charcoal text-white font-sans selection:bg-safety-orange selection:text-white">
            ...
            <Helmet>
                <title>Tradie Website Design Melbourne | Get More Local Jobs | Your Trade Partner</title>
                <meta name="description" content="Melbourne tradie website design and digital systems that get you found on Google, capture every enquiry, and stop you losing jobs to competitors across Greater Melbourne." />
                <link rel="canonical" href="https://yourtradepartner.com.au/tradie-website-design-melbourne" />
                <meta name="robots" content="index, follow" />
                <meta property="og:type" content="website" />
                <meta property="og:title" content="Tradie Website Design Melbourne | Your Trade Partner" />
                <meta property="og:description" content="Melbourne tradie website design and digital systems. Get found on Google, capture every enquiry, stop losing jobs to competitors." />
                <meta property="og:url" content="https://yourtradepartner.com.au/tradie-website-design-melbourne" />
                <meta property="og:image" content="https://yourtradepartner.com.au/Agency-hammer-favicon.jpeg" />
                <meta property="og:image:width" content="1200" />
                <meta property="og:image:height" content="630" />
                <script type="application/ld+json">{JSON.stringify({ "@context": "https://schema.org", "@type": "Service", "serviceType": "Tradie Website Design Melbourne", "name": "Tradie Website Design Melbourne", "description": "Professional website design and digital marketing systems for trade businesses in Melbourne, VIC.", "provider": { "@type": "LocalBusiness", "name": "Your Trade Partner", "url": "https://yourtradepartner.com.au", "telephone": "0451044751", "email": "hello@yourtradepartner.com.au" }, "areaServed": { "@type": "City", "name": "Melbourne", "containedInPlace": { "@type": "State", "name": "Victoria" } } })}</script>
                <script type="application/ld+json">{JSON.stringify({ "@context": "https://schema.org", "@type": "FAQPage", "mainEntity": [{ "@type": "Question", "name": "Do I need a website if I already get work by word of mouth in Melbourne?", "acceptedAnswer": { "@type": "Answer", "text": "Word of mouth works — until it stops. It doesn't reach the homeowner who just moved to Tarneit, needs a plumber, and searches Google at 8pm. A professional website and Google Business Profile means you're the tradie they find, even without a referral. Your word-of-mouth leads also check you out online before they call — and if you look weak, they call someone else." } }, { "@type": "Question", "name": "How long before I show up in Melbourne search results?", "acceptedAnswer": { "@type": "Answer", "text": "A properly set up Google Business Profile can appear in local results within days to weeks. Your website's SEO takes 3–6 months to build real ranking momentum in Melbourne's competitive market. If you need jobs faster, we can include Google Ads management to get calls coming in within days of launch." } }, { "@type": "Question", "name": "Melbourne is huge — can you target my specific area and trade corridor?", "acceptedAnswer": { "@type": "Answer", "text": "Yes. We build suburb-specific pages and SEO strategies targeting exactly where you work — whether that's the Eastern suburbs, the outer growth corridor, bayside, or the inner city. You don't need to rank across all of Melbourne, just in the suburbs that send you work." } }, { "@type": "Question", "name": "Can you build websites for any trade in Melbourne?", "acceptedAnswer": { "@type": "Answer", "text": "Yes. We've built digital systems for plumbers, electricians, roofers, builders, HVAC, landscapers, painters, concreters, and carpenters across Greater Melbourne. Each trade has different trust signals and search behaviour — we know the difference and build accordingly." } }, { "@type": "Question", "name": "What does a tradie website cost in Melbourne?", "acceptedAnswer": { "@type": "Answer", "text": "Our Trade-Ready Online Setup starts at $1,900 one-time + $299/quarter for hosting and support. The Local Jobs Engine (website + SEO + Google Business Profile) is $3,900 + $399/quarter. Full Growth System starts from $7,900. Every project is scoped before you commit — no surprises." } }] })}</script>
            </Helmet>
            ...
            <nav className="border-b border-white/10 bg-construction-charcoal/95 backdrop-blur-sm sticky top-0 z-50">
                <div className="container mx-auto px-6 py-4">
                    <div className="flex items-center justify-between">
                        ...
                        <Badge className="bg-safety-orange/10 text-safety-orange border-safety-orange/20 hover:bg-safety-orange/10 pointer-events-none"><MapPin className="w-3 h-3 mr-1" />Melbourne, VIC</Badge>
                    </div>
                </div>
            </nav>
            ...
            <header className="relative pt-8 pb-24 md:pt-24 md:pb-44 border-b border-white/5 overflow-hidden">
                ...
                <div className="container mx-auto px-6 relative z-10">
                    <Breadcrumbs items={[{ label: 'Home', href: '/' }]} currentLabel="Tradie Website Design Melbourne" currentPath="/tradie-website-design-melbourne" className="mb-8" />
                    <motion.div className="max-w-4xl mx-auto text-center" variants={containerVariants} initial="hidden" animate="visible">
                        <motion.p className="text-xs md:text-sm text-white/50 font-bold tracking-[0.2em] uppercase mb-6" variants={itemVariants}>Melbourne, Victoria</motion.p>
                        <motion.h1 className="text-[48px] md:text-[80px] font-black leading-[0.9] mb-4 uppercase italic" variants={itemVariants}>Melbourne Tradies:<br /><span className="text-safety-orange">Stop Losing Jobs Online</span></motion.h1>
                        <motion.p className="text-xs text-white/30 font-bold tracking-widest mb-8 -mt-2" variants={itemVariants}>Tradie website design Melbourne — built for Australia's second-largest trade market</motion.p>
                        <motion.p className="text-lg md:text-xl text-white/90 font-medium mb-10 leading-relaxed max-w-3xl mx-auto" variants={itemVariants}>Melbourne homeowners search Google before they call. With tradies competing across the inner city, Eastern suburbs, and outer growth corridors, if you don't show up, look professional, and make it easy to get in touch — they've already called someone else before you even know the job existed.</motion.p>
                        <motion.div className="inline-flex items-center gap-3 bg-white/5 border border-white/10 px-6 py-3 mb-10 rounded-full md:text-sm backdrop-blur-sm" variants={itemVariants}>
                            ...
                            <p className="font-semibold text-white/80">Built for VIC trade businesses — <span className="text-white/40">suburb-specific strategy, not a generic template.</span></p>
                        </motion.div>
                        <motion.div className="flex flex-col items-center gap-4" variants={itemVariants}>
                            ...
                            <p className="text-[10px] md:text-xs text-white/40 uppercase tracking-widest font-bold">No obligation · Melbourne-focused strategy · Results or we don't take your money</p>
                        </motion.div>
                        <motion.div className="flex flex-col md:flex-row justify-center items-center gap-4 md:gap-8 mt-12 text-sm text-white/60 font-bold uppercase tracking-wider" variants={itemVariants}>
                            <div className="flex items-center gap-2"><CheckCircle2 className="w-4 h-4 text-green-500" /><span>VIC trade specialists</span></div>
            ...
            <motion.section className="py-24 md:py-32 border-b border-white/5 bg-black/20" variants={sectionVariants} initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-50px" }}>
                <div className="container mx-auto px-6">
                    <div className="max-w-5xl mx-auto">
                        <h2 className="text-4xl md:text-6xl font-black mb-4 uppercase italic text-center md:text-left">What's happening to Melbourne tradies<br className="hidden md:block" /> without a strong online presence</h2>
                        <p className="text-white/40 font-bold uppercase tracking-widest mb-16 text-sm">Melbourne is Australia's second-largest trade market. The tradies winning are the ones who show up before the homeowner picks up the phone.</p>
                        <motion.div className="grid md:grid-cols-2 gap-8 mb-16" variants={containerVariants} initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-50px" }}>
                            {[
                                { title: "Ringwood homeowner, 7pm — searches Google, calls the first result", detail: "That tradie isn't better than you. They just show up first. Melbourne homeowners don't scroll past the top three results. If your Google Business Profile is thin, your website looks dated, or you don't rank for your suburb — that job goes to a competitor before you know it existed." },
                                { title: "Tarneit, Cranbourne, and Pakenham are booming — new homeowners who don't know any tradies yet", detail: "Melbourne's outer growth corridors are among the fastest-growing in Australia. These are first homeowners who have never lived in the area and search Google for every tradie they need. If you're not ranking in these suburbs, you're missing out on years of repeat business from new clients." },
                                { title: "You're stuck in Melbourne traffic while enquiries are going to whoever responds first", detail: "Melbourne's traffic means a lot of dead time between jobs. The tradies winning are the ones with a system: when an enquiry lands, a response goes out automatically, and the job is locked in. You can be stuck on the Eastern Freeway and still beat a faster tradie to the booking." },
                                { title: "Missed calls in the inner suburbs mean missed jobs — Melbourne homeowners move on fast", detail: "Inner-city Melbourne homeowners have options. If a homeowner in Hawthorn calls for a plumber and hits voicemail, they call the next result within minutes. A missed-call text-back system means you're never invisible — even when you're elbow-deep in a job in Frankston." }
                            ].map((item, i) => (
                        ...
                        <div className="text-center md:text-right"><p className="text-3xl md:text-5xl font-black italic uppercase leading-tight">You're not losing Melbourne jobs on price —<br /><span className="text-safety-orange underline decoration-white/20 underline-offset-8">you're losing them because they found someone else first.</span></p></div>
                    </div>
                </div>
            </motion.section>
            ...
            <motion.section className="py-24 md:py-32 border-b border-white/5 bg-black/30" variants={sectionVariants} initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-50px" }}>
                <div className="container mx-auto px-6">
                    <div className="max-w-6xl mx-auto">
                        <h2 className="text-4xl md:text-6xl font-black mb-4 uppercase italic text-center">What We Build for <span className="text-safety-orange">Melbourne Tradies</span></h2>
                        <p className="text-white/40 text-center font-bold uppercase tracking-widest mb-16">Not generic marketing. Systems built for how the VIC trade market actually works.</p>
                        <motion.div className="grid md:grid-cols-3 gap-8" variants={containerVariants} initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-50px" }}>
                            {[{ icon: "🌐", title: "Trade-Ready Website", features: ["Fast-loading, mobile-first (most searches are phone)", "Suburb pages targeting your Melbourne service area", "Click-to-call on every page", "Trust signals: licences, insurance, photos", "Quote forms that send directly to your phone", "Built to rank — not just look good"] }, { icon: "📍", title: "Local SEO & Google Profile", features: ["Google Business Profile set up and optimised", "Targeting Melbourne suburbs you actually work in", "Local citations submitted to AU directories", "Review strategy to build your rating fast", "Keyword targeting for your specific trade + area", "Track ranking positions monthly"] }, { icon: "⚡", title: "Enquiry Automation", features: ["Missed-call text-back so no job slips", "After-hours enquiry capture (jobs don't stop at 5pm)", "Instant SMS notification when a new job comes in", "AI enquiry handling for common questions", "Enquiry routing — right job to right person", "Works while you're on the tools"] }].map((item, i) => (
            ...
            <motion.section className="py-24 md:py-32 border-b border-white/5 bg-black/40" variants={sectionVariants} initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-50px" }}>
                <div className="container mx-auto px-6">
                    <div className="max-w-5xl mx-auto text-center">
                        <h2 className="text-4xl md:text-6xl font-black mb-4 uppercase italic">Serving Tradies Across <span className="text-safety-orange">Greater Melbourne</span></h2>
                        <p className="text-white/40 font-bold uppercase tracking-widest mb-12 text-sm">We work with trade businesses across the full Melbourne metro — Eastern Suburbs, Northern Growth Corridor, South-East, and the inner city.</p>
                        <div className="flex flex-wrap justify-center gap-3">{melbourneSuburbs.map((suburb, i) => <span key={i} className="bg-white/5 border border-white/10 px-4 py-2 text-xs font-black uppercase tracking-widest text-white/60 hover:border-safety-orange/40 hover:text-white/90 transition-colors">{suburb}</span>)}</div>
                        <p className="text-white/30 text-xs font-bold uppercase tracking-widest mt-8">Not in this list? Get in touch — if you're in VIC, we can help.</p>
                    </div>
                </div>
            </motion.section>
            ...
            <motion.section className="py-24 md:py-32 border-b border-white/5 bg-black/30" variants={sectionVariants} initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-50px" }}>
                <div className="container mx-auto px-6">
                    <div className="max-w-4xl mx-auto">
                        <h2 className="text-4xl md:text-6xl font-black mb-16 uppercase italic text-center">Questions from <span className="text-safety-orange">Melbourne Tradies</span></h2>
                        <motion.div className="space-y-6" variants={containerVariants} initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-50px" }}>
                            {[
                                { question: "Do I need a website if I already get work by word of mouth in Melbourne?", answer: "Word of mouth works — until it stops. It doesn't reach the homeowner who just moved to Tarneit, needs a plumber, and searches Google at 8pm. A professional website and Google Business Profile means you're the tradie they find, even without a referral. Your word-of-mouth leads also check you out online before they call — and if you look weak, they call someone else." },
                                { question: "How long before I show up in Melbourne search results?", answer: "A properly set up Google Business Profile can appear in local results within days to weeks. Your website's SEO takes 3–6 months to build real ranking momentum in Melbourne's competitive market. If you need jobs faster, we can include Google Ads management to get calls coming in within days of launch." },
                                { question: "Melbourne is huge — can you target my specific area and trade corridor?", answer: "Yes. We build suburb-specific pages and SEO strategies targeting exactly where you work — whether that's the Eastern suburbs, the outer growth corridor, bayside, or the inner city. You don't need to rank across all of Melbourne, just in the suburbs that send you work." },
                                { question: "Can you build websites for any trade in Melbourne?", answer: "Yes. We've built digital systems for plumbers, electricians, roofers, builders, HVAC, landscapers, painters, concreters, and carpenters across Greater Melbourne. Each trade has different trust signals and search behaviour — we know the difference and build accordingly." },
                                { question: "What does a tradie website cost in Melbourne?", answer: "Our Trade-Ready Online Setup starts at $1,900 one-time + $299/quarter for hosting and support. The Local Jobs Engine (website + SEO + Google Business Profile) is $3,900 + $399/quarter. Full Growth System starts from $7,900. Every project is scoped before you commit — no surprises." }
                            ].map((faq, i) => {
            ...
            <motion.section id="contact" className="py-24 md:py-32 bg-black/40" variants={sectionVariants} initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-50px" }}>
                <div className="container mx-auto px-6">
                    <div className="max-w-2xl md:max-w-5xl mx-auto">
                        ...
                        <p className="text-white/40 text-center font-bold uppercase tracking-widest mb-12 text-sm">Tell us your trade and we'll show you exactly what's costing you Melbourne jobs right now.</p>
                        {formStatus === 'success' ? (
                                ...
                                <div className="md:text-2xl md:leading-[2.4] md:text-white/80 font-medium">
                                    ...
                                    <span className="field-wrap block md:inline mb-4 md:mb-0">
                                        ...
                                        <input
                                            ...
                                            onChange={handleInputChange}
                                            className="w-full md:w-auto bg-white/5 border border-white/10 rounded-sm p-3 text-base font-medium text-white placeholder:text-white/30 focus:outline-none focus:border-safety-orange transition-colors md:inline-block md:align-baseline md:bg-transparent md:border-0 md:border-b-2 md:border-white/25 md:rounded-none md:px-1.5 md:py-0.5 md:text-2xl md:placeholder:text-white/30 md:w-56"
                                            placeholder="e.g. Ringwood, Dandenong, Footscray"
                                        />
...
export default MelbourneLocationPage;
