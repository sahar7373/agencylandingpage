...
const GoldCoastLocationPage = () => {
    ...
    const goldCoastSuburbs = [
        'Surfers Paradise', 'Broadbeach', 'Robina', 'Varsity Lakes', 'Burleigh Heads',
        'Coolangatta', 'Tweed Heads', 'Labrador', 'Southport', 'Parkwood',
        'Nerang', 'Mudgeeraba', 'Currumbin', 'Palm Beach', 'Tugun',
        'Miami', 'Mermaid Beach', 'Broadbeach Waters', 'Benowa', 'Ashmore',
        'Molendinar', 'Helensvale', 'Coomera', 'Pimpama', 'Upper Coomera',
        'Ormeau', 'Oxenford', 'Hope Island', 'Sanctuary Cove', 'Bilinga'
    ];
    ...
    return (
        <div className="min-h-screen bg-construction-charcoal text-white font-sans selection:bg-safety-orange selection:text-white">
            ...
            <Helmet>
                <title>Tradie Website Design Gold Coast | Get More Local Jobs | Your Trade Partner</title>
                <meta name="description" content="Gold Coast tradie website design and digital systems that get you found on Google, capture every enquiry, and stop you losing jobs across the Gold Coast corridor." />
                <link rel="canonical" href="https://yourtradepartner.com.au/tradie-website-design-gold-coast" />
                <meta name="robots" content="index, follow" />
                <meta property="og:type" content="website" />
                <meta property="og:title" content="Tradie Website Design Gold Coast | Your Trade Partner" />
                <meta property="og:description" content="Gold Coast tradie website design and digital systems. Get found on Google, capture every enquiry, stop losing jobs to competitors." />
                <meta property="og:url" content="https://yourtradepartner.com.au/tradie-website-design-gold-coast" />
                <meta property="og:image" content="https://yourtradepartner.com.au/Agency-hammer-favicon.jpeg" />
                <meta property="og:image:width" content="1200" />
                <meta property="og:image:height" content="630" />
                <script type="application/ld+json">{JSON.stringify({ "@context": "https://schema.org", "@type": "Service", "serviceType": "Tradie Website Design Gold Coast", "name": "Tradie Website Design Gold Coast", "description": "Professional website design and digital marketing systems for trade businesses on the Gold Coast, QLD.", "provider": { "@type": "LocalBusiness", "name": "Your Trade Partner", "url": "https://yourtradepartner.com.au", "telephone": "0451044751", "email": "hello@yourtradepartner.com.au" }, "areaServed": { "@type": "City", "name": "Gold Coast", "containedInPlace": { "@type": "State", "name": "Queensland" } } })}</script>
                <script type="application/ld+json">{JSON.stringify({ "@context": "https://schema.org", "@type": "FAQPage", "mainEntity": [{ "@type": "Question", "name": "Do I need a website if I already get work by word of mouth on the Gold Coast?", "acceptedAnswer": { "@type": "Answer", "text": "Word of mouth works — until it stops. The Gold Coast has one of Australia's highest turnover populations — new residents and holidaymakers who don't know any local tradies. They search Google for everything. A professional website and Google Business Profile means you're the tradie they find, not a competitor." } }, { "@type": "Question", "name": "How long before I show up in Gold Coast search results?", "acceptedAnswer": { "@type": "Answer", "text": "A properly set up Google Business Profile can appear in local results within days to weeks. Your website's SEO takes 3–6 months to build real ranking momentum. If you need jobs faster, we can include Google Ads management to get calls coming in within days of launch." } }, { "@type": "Question", "name": "The Gold Coast stretches from Coomera to Coolangatta — can you target my specific area?", "acceptedAnswer": { "@type": "Answer", "text": "Yes. We build suburb-specific pages and SEO strategies targeting exactly where you work — northern end, central, hinterland, or the Tweed border region. You don't need to rank across the whole Gold Coast, just in the areas that send you work." } }, { "@type": "Question", "name": "Can you build websites for any trade on the Gold Coast?", "acceptedAnswer": { "@type": "Answer", "text": "Yes. We've built digital systems for plumbers, electricians, roofers, builders, HVAC, landscapers, painters, concreters, and carpenters across the Gold Coast. Each trade has different trust signals and search behaviour — we know the difference and build accordingly." } }, { "@type": "Question", "name": "What does a tradie website cost on the Gold Coast?", "acceptedAnswer": { "@type": "Answer", "text": "Our Trade-Ready Online Setup starts at $1,900 one-time + $299/quarter for hosting and support. The Local Jobs Engine (website + SEO + Google Business Profile) is $3,900 + $399/quarter. Full Growth System starts from $7,900. Every project is scoped before you commit — no surprises." } }] })}</script>
            </Helmet>
            ...
            <nav className="border-b border-white/10 bg-construction-charcoal/95 backdrop-blur-sm sticky top-0 z-50">
                <div className="container mx-auto px-6 py-4">
                    <div className="flex items-center justify-between">
                        ...
                        <Badge className="bg-safety-orange/10 text-safety-orange border-safety-orange/20 hover:bg-safety-orange/10 pointer-events-none"><MapPin className="w-3 h-3 mr-1" />Gold Coast, QLD</Badge>
                    </div>
                </div>
            </nav>
            ...
            <header className="relative pt-8 pb-24 md:pt-24 md:pb-44 border-b border-white/5 overflow-hidden">
                ...
                <div className="container mx-auto px-6 relative z-10">
                    <Breadcrumbs items={[{ label: 'Home', href: '/' }]} currentLabel="Tradie Website Design Gold Coast" currentPath="/tradie-website-design-gold-coast" className="mb-8" />
                    <motion.div className="max-w-4xl mx-auto text-center" variants={containerVariants} initial="hidden" animate="visible">
                        <motion.p className="text-xs md:text-sm text-white/50 font-bold tracking-[0.2em] uppercase mb-6" variants={itemVariants}>Gold Coast, Queensland</motion.p>
                        <motion.h1 className="text-[48px] md:text-[80px] font-black leading-[0.9] mb-4 uppercase italic" variants={itemVariants}>
                            Gold Coast Tradies:<br /><span className="text-safety-orange">Stop Losing Jobs Online</span>
                        </motion.h1>
                        <motion.p className="text-xs text-white/30 font-bold tracking-widest mb-8 -mt-2" variants={itemVariants}>Tradie website design Gold Coast — built for one of Australia's fastest-growing trade markets</motion.p>
                        <motion.p className="text-lg md:text-xl text-white/90 font-medium mb-10 leading-relaxed max-w-3xl mx-auto" variants={itemVariants}>Gold Coast homeowners and new residents search Google before they call. With the city growing from Coomera to Coolangatta, if you don't show up, look professional, and make it easy to get in touch — they've already called someone else before you even know the job existed.</motion.p>
                        <motion.div className="inline-flex items-center gap-3 bg-white/5 border border-white/10 px-6 py-3 mb-10 rounded-full md:text-sm backdrop-blur-sm" variants={itemVariants}>
                            ...
                            <p className="font-semibold text-white/80">Built for Gold Coast trade businesses — <span className="text-white/40">suburb-specific strategy, not a generic template.</span></p>
                        </motion.div>
                        <motion.div className="flex flex-col items-center gap-4" variants={itemVariants}>
                            ...
                            <p className="text-[10px] md:text-xs text-white/40 uppercase tracking-widest font-bold">No obligation · Gold Coast-focused strategy · Results or we don't take your money</p>
                        </motion.div>
                        <motion.div className="flex flex-col md:flex-row justify-center items-center gap-4 md:gap-8 mt-12 text-sm text-white/60 font-bold uppercase tracking-wider" variants={itemVariants}>
                            <div className="flex items-center gap-2"><CheckCircle2 className="w-4 h-4 text-green-500" /><span>Gold Coast specialists</span></div>
            ...
            <motion.section className="py-24 md:py-32 border-b border-white/5 bg-black/20" variants={sectionVariants} initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-50px" }}>
                <div className="container mx-auto px-6">
                    <div className="max-w-5xl mx-auto">
                        <h2 className="text-4xl md:text-6xl font-black mb-4 uppercase italic text-center md:text-left">What's happening to Gold Coast tradies<br className="hidden md:block" /> without a strong online presence</h2>
                        <p className="text-white/40 font-bold uppercase tracking-widest mb-16 text-sm">The Gold Coast is one of Australia's fastest-growing regions. Tradies who show up online are eating the work of those who don't.</p>
                        <motion.div className="grid md:grid-cols-2 gap-8 mb-16" variants={containerVariants} initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-50px" }}>
                            {[
                                { title: "Robina homeowner, 6pm — searches Google, calls the first result", detail: "That tradie isn't better than you. They just show up first. Gold Coast homeowners don't scroll past the top three results. If your Google Business Profile is thin, your website looks dated, or you don't rank for your suburb — that job goes to a competitor before you know it existed." },
                                { title: "Coomera and Pimpama are exploding — full of new homeowners who don't know any local tradies yet", detail: "The northern Gold Coast is adding thousands of new homes every year. These are fresh homeowners who have no established tradie relationships. They Google everything. If you're not appearing in these growth suburbs, you're handing away a pipeline of recurring work to whoever set up their digital presence first." },
                                { title: "Tourists and new residents don't ask around — they Google the nearest professional", detail: "The Gold Coast has one of Australia's most transient populations. People who just moved here or are renovating an investment property search Google for every job. A professional website with strong local signals is the difference between being found and being passed over." },
                                { title: "Missed calls during a job in Tweed mean missed Gold Coast jobs — forever", detail: "The Gold Coast/NSW border region is busy and spread out. If a homeowner in Helensvale calls while you're finishing a job in Coolangatta and hits voicemail, they call the next result. An automated callback system means you capture every enquiry, no matter where you're working." }
                            ].map((item, i) => (
                        ...
                        <div className="text-center md:text-right">
                            <p className="text-3xl md:text-5xl font-black italic uppercase leading-tight">You're not losing Gold Coast jobs on price —<br /><span className="text-safety-orange underline decoration-white/20 underline-offset-8">you're losing them because they found someone else first.</span></p>
                        </div>
                    </div>
                </div>
            </motion.section>
            ...
            <motion.section className="py-24 md:py-32 border-b border-white/5 bg-black/30" variants={sectionVariants} initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-50px" }}>
                <div className="container mx-auto px-6">
                    <div className="max-w-6xl mx-auto">
                        <h2 className="text-4xl md:text-6xl font-black mb-4 uppercase italic text-center">What We Build for <span className="text-safety-orange">Gold Coast Tradies</span></h2>
                        <p className="text-white/40 text-center font-bold uppercase tracking-widest mb-16">Not generic marketing. Systems built for how the Gold Coast trade market actually works.</p>
                        <motion.div className="grid md:grid-cols-3 gap-8" variants={containerVariants} initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-50px" }}>
                            {[
                                { icon: "🌐", title: "Trade-Ready Website", features: ["Fast-loading, mobile-first (most searches are phone)", "Suburb pages targeting your Gold Coast service area", "Click-to-call on every page", "Trust signals: licences, insurance, photos", "Quote forms that send directly to your phone", "Built to rank — not just look good"] },
                                { icon: "📍", title: "Local SEO & Google Profile", features: ["Google Business Profile set up and optimised", "Targeting Gold Coast suburbs you actually work in", "Local citations submitted to AU directories", "Review strategy to build your rating fast", "Keyword targeting for your specific trade + area", "Track ranking positions monthly"] },
            ...
            <motion.section className="py-24 md:py-32 border-b border-white/5 bg-black/40" variants={sectionVariants} initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-50px" }}>
                <div className="container mx-auto px-6">
                    <div className="max-w-5xl mx-auto text-center">
                        <h2 className="text-4xl md:text-6xl font-black mb-4 uppercase italic">Serving Tradies Across <span className="text-safety-orange">the Gold Coast</span></h2>
                        <p className="text-white/40 font-bold uppercase tracking-widest mb-12 text-sm">We work with trade businesses across the full Gold Coast corridor — Northern end, Central, Hinterland, and the Tweed border region.</p>
                        <div className="flex flex-wrap justify-center gap-3">
                            {goldCoastSuburbs.map((suburb, i) => <span key={i} className="bg-white/5 border border-white/10 px-4 py-2 text-xs font-black uppercase tracking-widest text-white/60 hover:border-safety-orange/40 hover:text-white/90 transition-colors">{suburb}</span>)}
                        </div>
                        <p className="text-white/30 text-xs font-bold uppercase tracking-widest mt-8">Not in this list? Get in touch — if you're in SE Queensland or northern NSW, we can help.</p>
                    </div>
                </div>
            </motion.section>
                        ...
                        <motion.div whileHover={hoverLift} className="h-full">
                            <Card className="bg-white/5 border-2 border-white/10 rounded-none h-full flex flex-col">
                                ...
                                <div className={`${expandedPackages.includes(1) ? 'block' : 'hidden'} md:block flex-grow flex flex-col`}>
                                    ...
                                    <CardFooter className="p-5 md:p-6 pt-0 flex flex-col gap-4"><div className="bg-white/10 p-4 text-xs font-black uppercase tracking-widest text-center italic w-full">"You stop looking like a "maybe" and start looking like a real business people call."</div><a href="#contact" className="w-full"><Button className="w-full bg-white text-black hover:bg-white/90 rounded-none h-12 font-black uppercase tracking-widest">Check Availability</Button></a></CardFooter>
                                </div>
                            </Card>
                        </motion.div>
                                ...
                                <div className={`${expandedPackages.includes(3) ? 'block' : 'hidden'} md:block flex-grow flex flex-col`}>
                                    <CardContent className="p-5 md:p-6 space-y-6 flex-grow">
                                        ...
                                        <div className="space-y-4">
                                            ...
                                            <div><p className="text-xs font-bold uppercase tracking-widest text-white/40 mb-3">Everything in Local Jobs Engine, plus:</p>
                                                <div className="space-y-4">
                        ...
                        <motion.div whileHover={hoverLift} className="h-full">
                            <Card className="bg-white/5 border-2 border-white/10 rounded-none h-full flex flex-col">
                                ...
                                <div className={`${expandedPackages.includes(2) ? 'block' : 'hidden'} md:block flex-grow flex flex-col`}>
                                    ...
                                    <CardFooter className="p-5 md:p-6 pt-0 flex flex-col gap-4"><div className="bg-white/10 p-4 text-xs font-black uppercase tracking-widest text-center italic w-full">"You miss fewer calls, look more established, and turn attention into booked work."</div><a href="#contact" className="w-full"><Button className="w-full bg-white text-black hover:bg-white/90 rounded-none h-12 font-black uppercase tracking-widest">Get The Jobs Engine Ready</Button></a></CardFooter>
                                </div>
                            </Card>
                        </motion.div>
                    </div>
            ...
            <motion.section className="py-24 md:py-32 border-b border-white/5 bg-black/30" variants={sectionVariants} initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-50px" }}>
                <div className="container mx-auto px-6">
                    <div className="max-w-4xl mx-auto">
                        <h2 className="text-4xl md:text-6xl font-black mb-16 uppercase italic text-center">Questions from <span className="text-safety-orange">Gold Coast Tradies</span></h2>
                        <motion.div className="space-y-6" variants={containerVariants} initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-50px" }}>
                            {[
                                { question: "Do I need a website if I already get work by word of mouth on the Gold Coast?", answer: "Word of mouth works — until it stops. The Gold Coast has one of Australia's highest turnover populations — new residents and holidaymakers who don't know any local tradies. They search Google for everything. A professional website and Google Business Profile means you're the tradie they find, not a competitor." },
                                { question: "How long before I show up in Gold Coast search results?", answer: "A properly set up Google Business Profile can appear in local results within days to weeks. Your website's SEO takes 3–6 months to build real ranking momentum. If you need jobs faster, we can include Google Ads management to get calls coming in within days of launch." },
                                { question: "The Gold Coast stretches from Coomera to Coolangatta — can you target my specific area?", answer: "Yes. We build suburb-specific pages and SEO strategies targeting exactly where you work — northern end, central, hinterland, or the Tweed border region. You don't need to rank across the whole Gold Coast, just in the areas that send you work." },
                                { question: "Can you build websites for any trade on the Gold Coast?", answer: "Yes. We've built digital systems for plumbers, electricians, roofers, builders, HVAC, landscapers, painters, concreters, and carpenters across the Gold Coast. Each trade has different trust signals and search behaviour — we know the difference and build accordingly." },
                                { question: "What does a tradie website cost on the Gold Coast?", answer: "Our Trade-Ready Online Setup starts at $1,900 one-time + $299/quarter for hosting and support. The Local Jobs Engine (website + SEO + Google Business Profile) is $3,900 + $399/quarter. Full Growth System starts from $7,900. Every project is scoped before you commit — no surprises." }
                            ].map((faq, i) => {
            ...
            <motion.section id="contact" className="py-24 md:py-32 bg-black/40" variants={sectionVariants} initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-50px" }}>
                <div className="container mx-auto px-6">
                    <div className="max-w-2xl mx-auto">
                        ...
                        <p className="text-white/40 text-center font-bold uppercase tracking-widest mb-12 text-sm">Tell us your trade and we'll show you exactly what's costing you Gold Coast jobs right now.</p>
                        {formStatus === 'success' ? (
...
export default GoldCoastLocationPage;
