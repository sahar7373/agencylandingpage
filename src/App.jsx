...
function App() {
    ...
    return (
        <div className="min-h-screen bg-construction-charcoal text-white font-sans selection:bg-safety-orange selection:text-white pb-20">
            ...
            <nav className="border-b border-white/5 py-4 bg-construction-charcoal/95 backdrop-blur-md sticky top-0 z-50">
                <div className="container mx-auto px-4 md:px-6 flex items-center justify-between">
                    <div className="flex items-center gap-2">
                        ...
                        <span className="text-lg md:text-xl font-black uppercase tracking-tighter">YourTradePartner</span>
                    </div>
                ...
                <div className="container mx-auto px-6">
                    ...
                    <div className="mt-20 max-w-4xl mx-auto">
                        <div className="bg-white/5 border border-white/10 p-8 md:p-12 text-center rounded-sm relative overflow-hidden">
                            ...
                            <div className="grid md:grid-cols-2 gap-8 text-left mb-8">
                                <div className="space-y-4">
                                    <p className="text-white/60 font-medium leading-relaxed">
                                        Most agencies charge you <span className="text-white font-bold">$3k–$6k upfront</span>, hand over a site, and disappear.
                                    </p>
                                    <p className="text-white/60 font-medium leading-relaxed">
                                        If it works — great. If it doesn’t — not their problem.
                                        <span className="block mt-2 text-white font-black uppercase italic">We don’t work like that.</span>
                                    </p>
                                </div>
                                <div className="space-y-3">
                                    <ul className="space-y-3">
                                        {[
                                            "The website is included when you partner with us",
                                            "The real value is the system: structure, positioning, visibility",
                                            "Hosting, maintenance, and improvements handled yearly",
                                            "We stay involved — because your results matter to us"
                                        ].map((item, i) => (
                                            <li key={i} className="flex items-start gap-3 text-sm font-bold text-white/80">
                            ...
                            <p className="text-sm font-black uppercase tracking-widest text-white/40 italic border-t border-white/10 pt-6">
                                "If we charged you upfront and walked away, we’d have no reason to care if it performed."
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div className="container mx-auto px-6">
                    ...
                    <div className="mt-16 text-center">
                        <a
                            href="/guide.pdf"
                            download
                            className="inline-flex items-center gap-2 text-white/40 hover:text-safety-orange font-bold uppercase tracking-widest text-xs transition-colors border-b border-white/20 hover:border-safety-orange pb-1"
                        >
                            <span className="text-xl">↓</span> Get a free guide
                        </a>
                    </div>
                </div>
                    ...
                    {formStatus === 'success' ? (
                        ...
                        <div className="max-w-xl mx-auto">
                            ...
                            <form onSubmit={handleSubmit} className="text-left space-y-6 bg-zinc-900/80 p-6 md:p-8 border border-white/10 backdrop-blur-sm shadow-2xl">
                                ...
                                <div className="grid grid-cols-2 gap-4">
                                    <div className="space-y-1">
                                        <label className="block text-xs font-bold uppercase tracking-widest text-white/60">Website</label>
            ...
            <footer className="bg-black py-20 border-t border-white/10">
                <div className="container mx-auto px-6 flex flex-col md:flex-row justify-between items-center gap-10">
                    <div className="flex items-center gap-2">
                        ...
                        <span className="text-2xl font-black uppercase tracking-tighter">YourTradePartner</span>
                    </div>
